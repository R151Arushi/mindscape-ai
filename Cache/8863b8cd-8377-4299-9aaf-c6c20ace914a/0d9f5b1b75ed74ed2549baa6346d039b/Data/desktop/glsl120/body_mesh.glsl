...
{
if (Port_Opacity_N023<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
vec3 l9_13=mix(vec3(0.04),l9_8*l9_6,l9_12);
...
#endif
l9_69=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_70,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_71;
...
#else
{
l9_71=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_68,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_69=l9_71;
}
...
float l9_77=l9_75.y;
float l9_78=l9_75.z;
l9_74=(((((((sc_Sh[8]*0.429043)*((l9_76*l9_76)-(l9_77*l9_77)))+((sc_Sh[6]*0.743125)*(l9_78*l9_78)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_76*l9_77))+(sc_Sh[7]*(l9_76*l9_78)))+(sc_Sh[5]*(l9_77*l9_78)))*0.858086))+((((sc_Sh[3]*l9_76)+(sc_Sh[1]*l9_77))+(sc_Sh[2]*l9_78))*1.02333))*sc_ShIntensity;
}
#else
{
l9_74=vec3(0.0);
...
float l9_98=0.36*l9_92;
float l9_99=0.694444*l9_97;
...
l9_90=l9_89+((((sc_LightEstimationData.sg[l9_91].color/vec3(sc_LightEstimationData.sg[l9_91].sharpness))*6.28319)*((l9_96*l9_101)+(((l9_93-l9_94)*l9_95)-l9_94)))*vec3(0.31831));
l9_89=l9_90;
l9_91++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_103=clamp(pow(l9_7,0.666667),0.0,1.0)*5.0;
...
#endif
l9_102=(((l9_105.xyz*(1.0/l9_105.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_15,abs(dot(l9_9,l9_0)));
}
#else
{
l9_102=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_109=clamp(l9_7*l9_7,0.01,1.0);
vec3 l9_110;
...
float l9_115=(2.0/l9_112)/(4.0*max(l9_114,0.0001));
...
{
vec4 l9_136=l9_134;
l9_136.x=l9_133+((l9_11.x*Port_SpecularAO_N023.x)*1e-05);
l9_135=l9_136;
}
#else
{
...
{
vec3 l9_138=linearToneMapping(l9_135.xyz);
l9_137=vec4(l9_138.x,l9_138.y,l9_138.z,l9_135.w);
}
#else
{
l9_137=l9_135;
...
#endif
vec3 l9_139=vec3(linearToSrgb(l9_137.x),linearToSrgb(l9_137.y),linearToSrgb(l9_137.z));
l9_5=vec4(l9_139.x,l9_139.y,l9_139.z,l9_137.w);
}
#else
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_143=clamp(l9_140.w*2.0,0.0,1.0);
}
#else
{
float l9_144;
...
{
l9_144=clamp(dot(l9_140.xyz,vec3(l9_140.w)),0.0,1.0);
}
#else
{
float l9_145;
...
#if (sc_BlendMode_Multiply)
{
l9_146=(1.0-dot(l9_140.xyz,vec3(0.33333)))*l9_140.w;
}
#else
{
float l9_147;
...
{
l9_147=(1.0-clamp(dot(l9_140.xyz,vec3(1.0)),0.0,1.0))*l9_140.w;
}
#else
{
float l9_148;
#if (sc_BlendMode_ColoredGlass)
{
l9_148=clamp(dot(l9_140.xyz,vec3(1.0)),0.0,1.0)*l9_140.w;
}
#else
{
float l9_149;
#if (sc_BlendMode_Add)
{
l9_149=clamp(dot(l9_140.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_150;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_150=clamp(dot(l9_140.xyz,vec3(1.0)),0.0,1.0)*l9_140.w;
}
#else
{
float l9_151;
...
{
l9_151=dot(l9_140.xyz,vec3(0.33333))*l9_140.w;
}
#else
{
float l9_152;
#if (sc_BlendMode_Min)
{
l9_152=1.0-clamp(dot(l9_140.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_153;
#if (sc_BlendMode_Max)
{
l9_153=clamp(dot(l9_140.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_153=1.0;
...
#endif
l9_141=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_140.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_142);
}
#else
{
vec4 l9_154;
...
vec3 l9_157=mix(l9_156,definedBlend(l9_156,l9_140.xyz).xyz,vec3(l9_140.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_160=l9_140.w;
l9_159=vec4(mix(vec3(1.0),l9_140.xyz,vec3(l9_160)),l9_160);
}
#else
{
vec4 l9_161;
...
#endif
l9_161=vec4(l9_140.xyz*l9_163,l9_163);
}
#else
{
l9_161=l9_140;
...
{
l9_166=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_166=vec4(0.0);
...
vec4 l9_168=max(l9_167,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_170=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_170),min(1.0,l9_170+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_171=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
vec4 l9_174=vec4(0.0);
l9_174.x=l9_173;
vec4 l9_176=l9_174;
l9_176.y=packValue(l9_172);
vec4 l9_178=l9_176;
l9_178.z=packValue(l9_172);
vec4 l9_180=l9_178;
l9_180.w=packValue(l9_172);
vec4 l9_182=vec4(0.0);
l9_182.x=packValue(l9_172);
vec4 l9_184=l9_182;
l9_184.y=packValue(l9_172);
vec4 l9_186=l9_184;
l9_186.z=packValue(l9_172);
vec4 l9_187=l9_186;
l9_187.w=packValue(l9_172);
int l9_188=int(l9_169.w*255.0);
float l9_189=packValue(l9_188);
vec4 l9_190=vec4(0.0);
l9_190.x=l9_189;
vec4 l9_192=l9_190;
l9_192.y=packValue(l9_188);
vec4 l9_194=l9_192;
l9_194.z=packValue(l9_188);
vec4 l9_195=l9_194;
l9_195.w=packValue(l9_188);
sc_writeFragData0(l9_187);
sc_writeFragData1(l9_180);
sc_writeFragData2(l9_195);
...
#if (sc_OITCompositingPass)
{
vec2 l9_196=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_207==0)
{
l9_210=texture2D(sc_OITAlpha0,l9_196);
l9_209=texture2D(sc_OITDepthLow0,l9_196);
l9_208=texture2D(sc_OITDepthHigh0,l9_196);
}
else
{
l9_210=l9_203;
...
if (l9_207==1)
{
l9_206=texture2D(sc_OITAlpha1,l9_196);
l9_205=texture2D(sc_OITDepthLow1,l9_196);
l9_204=texture2D(sc_OITDepthHigh1,l9_196);
}
else
{
l9_206=l9_210;
...
{
int l9_211[8]=l9_197;
unpackValues(l9_204.w,l9_207,l9_211);
unpackValues(l9_204.z,l9_207,l9_211);
unpackValues(l9_204.y,l9_207,l9_211);
unpackValues(l9_204.x,l9_207,l9_211);
unpackValues(l9_205.w,l9_207,l9_211);
unpackValues(l9_205.z,l9_207,l9_211);
unpackValues(l9_205.y,l9_207,l9_211);
unpackValues(l9_205.x,l9_207,l9_211);
int l9_220[8]=l9_198;
unpackValues(l9_206.w,l9_207,l9_220);
unpackValues(l9_206.z,l9_207,l9_220);
unpackValues(l9_206.y,l9_207,l9_220);
unpackValues(l9_206.x,l9_207,l9_220);
}
l9_203=l9_206;
l9_202=l9_205;
l9_201=l9_204;
...
vec4 l9_225=texture2D(sc_OITFilteredDepthBoundsTexture,l9_196);
vec2 l9_226=l9_225.xy;
int l9_227;
#if (sc_SkinBonesCount>0)
{
l9_227=encodeDepth(((1.0-l9_225.x)*1000.0)+getDepthOrderingEpsilon(),l9_226);
}
#else
{
l9_227=0;
...
#endif
int l9_228=encodeDepth(viewSpaceDepth(),l9_226);
vec4 l9_229;
l9_229=l9_169*l9_169.w;
vec4 l9_230;
int l9_231=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_231<8)
{
int l9_232=l9_197[l9_231];
int l9_233=l9_228-l9_227;
bool l9_234=l9_232<l9_233;
bool l9_235;
if (l9_234)
{
l9_235=l9_197[l9_231]>0;
}
else
{
l9_235=l9_234;
...
if (l9_235)
{
vec3 l9_236=l9_229.xyz*(1.0-(float(l9_198[l9_231])*0.00392157));
l9_230=vec4(l9_236.x,l9_236.y,l9_236.z,l9_229.w);
}
else
{
l9_230=l9_229;
