...
{
if (l9_5<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
vec3 l9_15=mix(vec3(0.04),l9_10*l9_8,l9_14);
...
#endif
l9_71=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_72,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_73;
...
#else
{
l9_73=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_70,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_71=l9_73;
}
...
float l9_79=l9_77.y;
float l9_80=l9_77.z;
l9_76=(((((((sc_Sh[8]*0.429043)*((l9_78*l9_78)-(l9_79*l9_79)))+((sc_Sh[6]*0.743125)*(l9_80*l9_80)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_78*l9_79))+(sc_Sh[7]*(l9_78*l9_80)))+(sc_Sh[5]*(l9_79*l9_80)))*0.858086))+((((sc_Sh[3]*l9_78)+(sc_Sh[1]*l9_79))+(sc_Sh[2]*l9_80))*1.02333))*sc_ShIntensity;
}
#else
{
l9_76=vec3(0.0);
...
float l9_100=0.36*l9_94;
float l9_101=0.694444*l9_99;
...
l9_92=l9_91+((((sc_LightEstimationData.sg[l9_93].color/vec3(sc_LightEstimationData.sg[l9_93].sharpness))*6.28319)*((l9_98*l9_103)+(((l9_95-l9_96)*l9_97)-l9_96)))*vec3(0.31831));
l9_91=l9_92;
l9_93++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_105=clamp(pow(l9_9,0.666667),0.0,1.0)*5.0;
...
#endif
l9_104=(((l9_107.xyz*(1.0/l9_107.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_17,abs(dot(l9_11,l9_0)));
}
#else
{
l9_104=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_111=clamp(l9_9*l9_9,0.01,1.0);
vec3 l9_112;
...
float l9_117=(2.0/l9_114)/(4.0*max(l9_116,0.0001));
...
l9_112+=((((((((vec3(0.31831/l9_114)*exp((l9_118-l9_117)-sc_LightEstimationData.sg[l9_113].sharpness))*sc_LightEstimationData.sg[l9_113].color)*6.28319)*(1.0-exp((-2.0)*l9_118)))/vec3(l9_118))*((1.0/(l9_119+sqrt(l9_114+((l9_121*l9_119)*l9_119))))*(1.0/(l9_120+sqrt(l9_114+((l9_121*l9_120)*l9_120))))))*(l9_15+((vec3(1.0)-l9_15)*pow(1.0-clamp(dot(l9_115,normalize(l9_115+l9_0)),0.0,1.0),5.0))))*l9_119);
l9_113++;
continue;
}
else
...
{
vec4 l9_138=l9_136;
l9_138.x=l9_135+((l9_13.x*Port_SpecularAO_N006.x)*1e-05);
l9_137=l9_138;
}
#else
{
...
{
vec3 l9_140=linearToneMapping(l9_137.xyz);
l9_139=vec4(l9_140.x,l9_140.y,l9_140.z,l9_137.w);
}
#else
{
l9_139=l9_137;
...
#endif
vec3 l9_141=vec3(linearToSrgb(l9_139.x),linearToSrgb(l9_139.y),linearToSrgb(l9_139.z));
l9_7=vec4(l9_141.x,l9_141.y,l9_141.z,l9_139.w);
}
#else
{
l9_7=vec4(l9_6,l9_5);
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_145=clamp(l9_142.w*2.0,0.0,1.0);
}
#else
{
float l9_146;
...
{
l9_146=clamp(dot(l9_142.xyz,vec3(l9_142.w)),0.0,1.0);
}
#else
{
float l9_147;
...
#if (sc_BlendMode_Multiply)
{
l9_148=(1.0-dot(l9_142.xyz,vec3(0.33333)))*l9_142.w;
}
#else
{
float l9_149;
...
{
l9_149=(1.0-clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0))*l9_142.w;
}
#else
{
float l9_150;
#if (sc_BlendMode_ColoredGlass)
{
l9_150=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0)*l9_142.w;
}
#else
{
float l9_151;
#if (sc_BlendMode_Add)
{
l9_151=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_152;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_152=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0)*l9_142.w;
}
#else
{
float l9_153;
...
{
l9_153=dot(l9_142.xyz,vec3(0.33333))*l9_142.w;
}
#else
{
float l9_154;
#if (sc_BlendMode_Min)
{
l9_154=1.0-clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_155;
#if (sc_BlendMode_Max)
{
l9_155=clamp(dot(l9_142.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_155=1.0;
...
#endif
l9_143=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_142.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_144);
}
#else
{
vec4 l9_156;
...
{
vec3 l9_158=sc_GetFramebufferColor().xyz;
vec3 l9_159=mix(l9_158,definedBlend(l9_158,l9_142.xyz).xyz,vec3(l9_142.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_162=l9_142.w;
l9_161=vec4(mix(vec3(1.0),l9_142.xyz,vec3(l9_162)),l9_162);
}
#else
{
vec4 l9_163;
...
{
float l9_164=l9_142.w;
float l9_165;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_165=clamp(l9_164,0.0,1.0);
}
#else
{
l9_165=l9_164;
...
#endif
l9_163=vec4(l9_142.xyz*l9_165,l9_165);
}
#else
{
l9_163=l9_142;
...
{
l9_168=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_168=vec4(0.0);
...
vec4 l9_170=max(l9_169,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_172=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_172),min(1.0,l9_172+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_176.x=l9_175;
vec4 l9_178=l9_176;
l9_178.y=packValue(l9_174);
vec4 l9_180=l9_178;
l9_180.z=packValue(l9_174);
vec4 l9_182=l9_180;
l9_182.w=packValue(l9_174);
vec4 l9_184=vec4(0.0);
l9_184.x=packValue(l9_174);
vec4 l9_186=l9_184;
l9_186.y=packValue(l9_174);
vec4 l9_188=l9_186;
l9_188.z=packValue(l9_174);
vec4 l9_189=l9_188;
l9_189.w=packValue(l9_174);
int l9_190=int(l9_171.w*255.0);
float l9_191=packValue(l9_190);
vec4 l9_192=vec4(0.0);
l9_192.x=l9_191;
vec4 l9_194=l9_192;
l9_194.y=packValue(l9_190);
vec4 l9_196=l9_194;
l9_196.z=packValue(l9_190);
vec4 l9_197=l9_196;
l9_197.w=packValue(l9_190);
sc_writeFragData0(l9_189);
sc_writeFragData1(l9_182);
sc_writeFragData2(l9_197);
...
if (l9_209==0)
{
l9_212=texture2D(sc_OITAlpha0,l9_198);
l9_211=texture2D(sc_OITDepthLow0,l9_198);
l9_210=texture2D(sc_OITDepthHigh0,l9_198);
}
else
{
l9_212=l9_205;
...
if (l9_209==1)
{
l9_208=texture2D(sc_OITAlpha1,l9_198);
l9_207=texture2D(sc_OITDepthLow1,l9_198);
l9_206=texture2D(sc_OITDepthHigh1,l9_198);
}
else
{
l9_208=l9_212;
...
if (any(notEqual(l9_206,vec4(0.0)))||any(notEqual(l9_207,vec4(0.0))))
{
int l9_213[8]=l9_199;
unpackValues(l9_206.w,l9_209,l9_213);
unpackValues(l9_206.z,l9_209,l9_213);
unpackValues(l9_206.y,l9_209,l9_213);
unpackValues(l9_206.x,l9_209,l9_213);
unpackValues(l9_207.w,l9_209,l9_213);
unpackValues(l9_207.z,l9_209,l9_213);
unpackValues(l9_207.y,l9_209,l9_213);
unpackValues(l9_207.x,l9_209,l9_213);
int l9_222[8]=l9_200;
unpackValues(l9_208.w,l9_209,l9_222);
unpackValues(l9_208.z,l9_209,l9_222);
unpackValues(l9_208.y,l9_209,l9_222);
unpackValues(l9_208.x,l9_209,l9_222);
}
l9_205=l9_208;
l9_204=l9_207;
l9_203=l9_206;
...
vec4 l9_227=texture2D(sc_OITFilteredDepthBoundsTexture,l9_198);
vec2 l9_228=l9_227.xy;
int l9_229;
#if (sc_SkinBonesCount>0)
{
l9_229=encodeDepth(((1.0-l9_227.x)*1000.0)+getDepthOrderingEpsilon(),l9_228);
}
#else
{
l9_229=0;
...
#endif
int l9_230=encodeDepth(viewSpaceDepth(),l9_228);
vec4 l9_231;
l9_231=l9_171*l9_171.w;
vec4 l9_232;
int l9_233=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_233<8)
{
int l9_234=l9_199[l9_233];
int l9_235=l9_230-l9_229;
bool l9_236=l9_234<l9_235;
bool l9_237;
if (l9_236)
{
l9_237=l9_199[l9_233]>0;
}
else
{
l9_237=l9_236;
...
if (l9_237)
{
vec3 l9_238=l9_231.xyz*(1.0-(float(l9_200[l9_233])*0.00392157));
l9_232=vec4(l9_238.x,l9_238.y,l9_238.z,l9_231.w);
}
else
{
l9_232=l9_231;
