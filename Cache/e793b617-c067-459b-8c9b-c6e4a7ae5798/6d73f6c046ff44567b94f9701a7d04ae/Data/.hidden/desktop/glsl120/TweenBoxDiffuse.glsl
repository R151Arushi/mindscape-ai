...
#endif
vec3 l9_42=mix(vec3(0.0,0.0,1.0),((l9_33.xyz*1.99219)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
...
{
if (l9_51<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
#endif
vec3 l9_58=l9_54*1.0;
SurfaceProperties l9_59=SurfaceProperties(l9_58,l9_51,l9_55,varPos,l9_3,0.0,1.0,l9_56,l9_57,vec3(1.0),vec3(1.0),vec3(0.04));
vec4 l9_60=vec4(1.0);
vec3 l9_61;
vec3 l9_62;
vec3 l9_63;
...
vec2 l9_113=vec2(0.0);
l9_113.x=(((l9_112<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_111/length(vec2(l9_112,l9_111)),-1.0,1.0)))-1.5708;
vec2 l9_114=l9_113;
l9_114.y=acos(l9_55.y);
vec2 l9_115=l9_114*vec2(0.159155,0.31831);
vec2 l9_116=l9_115;
l9_116.y=1.0-l9_115.y;
float l9_117=l9_115.x+(sc_EnvmapRotation.y*0.00277778);
vec2 l9_118=l9_116;
l9_118.x=fract((l9_117+floor(l9_117))+1.0);
vec4 l9_119;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_120=calcSeamlessPanoramicUvsForSampling(l9_118,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_120=l9_118;
...
#endif
l9_119=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_120,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_121;
...
{
vec2 l9_122=calcSeamlessPanoramicUvsForSampling(l9_118,sc_EnvmapDiffuseSize.xy,0.0);
int l9_123;
...
#endif
l9_121=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_122,sc_EnvmapDiffuseLayout,l9_123,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_121=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_118,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_119=l9_121;
}
#endif
l9_110=(l9_119.xyz*(1.0/l9_119.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_124;
...
float l9_127=l9_125.y;
float l9_128=l9_125.z;
l9_124=(((((((sc_Sh[8]*0.429043)*((l9_126*l9_126)-(l9_127*l9_127)))+((sc_Sh[6]*0.743125)*(l9_128*l9_128)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_126*l9_127))+(sc_Sh[7]*(l9_126*l9_128)))+(sc_Sh[5]*(l9_127*l9_128)))*0.858086))+((((sc_Sh[3]*l9_126)+(sc_Sh[1]*l9_127))+(sc_Sh[2]*l9_128))*1.02333))*sc_ShIntensity;
}
#else
{
l9_124=vec3(0.0);
...
{
l9_130=l9_110+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_131=l9_110;
l9_131.x=l9_110.x+(1e-06*sc_AmbientLights[0].color.x);
l9_130=l9_131;
}
#endif
l9_129=l9_130;
...
{
l9_133=l9_129+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_134=l9_129;
l9_134.x=l9_129.x+(1e-06*sc_AmbientLights[1].color.x);
l9_133=l9_134;
}
#endif
l9_132=l9_133;
...
{
l9_136=l9_132+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_137=l9_132;
l9_137.x=l9_132.x+(1e-06*sc_AmbientLights[2].color.x);
l9_136=l9_137;
}
#endif
l9_135=l9_136;
...
{
vec3 l9_139;
l9_139=sc_LightEstimationData.ambientLight;
vec3 l9_140;
int l9_141=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_141<sc_LightEstimationSGCount)
{
float l9_142=dot(sc_LightEstimationData.sg[l9_141].axis,l9_55);
float l9_143=exp(-sc_LightEstimationData.sg[l9_141].sharpness);
float l9_144=l9_143*l9_143;
float l9_145=1.0/sc_LightEstimationData.sg[l9_141].sharpness;
float l9_146=(1.0+(2.0*l9_144))-l9_145;
float l9_147=sqrt(1.0-l9_146);
float l9_148=0.36*l9_142;
float l9_149=0.694444*l9_147;
float l9_150=l9_148+l9_149;
float l9_151;
if (step(abs(l9_148),l9_149)>0.5)
{
l9_151=(l9_150*l9_150)/l9_147;
}
else
{
l9_151=clamp(l9_142,0.0,1.0);
}
l9_140=l9_139+((((sc_LightEstimationData.sg[l9_141].color/vec3(sc_LightEstimationData.sg[l9_141].sharpness))*6.28319)*((l9_146*l9_151)+(((l9_143-l9_144)*l9_145)-l9_144)))*vec3(0.31831));
l9_139=l9_140;
l9_141++;
continue;
}
...
l9_155=vec3(0.0);
l9_154=vec3(0.0);
l9_153=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_58,vec3(l9_51));
l9_152=1.0;
}
#else
{
...
#endif
vec3 l9_157=l9_154*l9_57;
vec3 l9_158=l9_155+l9_157;
vec3 l9_159=l9_58*l9_158;
vec3 l9_160;
if (l9_156)
{
l9_160=l9_159*srgbToLinear(l9_152);
}
else
{
l9_160=l9_159;
}
vec3 l9_161=l9_160+l9_83;
vec3 l9_162=(l9_161+l9_56)+l9_153;
float l9_163=l9_162.x;
vec4 l9_164=vec4(l9_163,l9_162.yz,l9_152);
vec4 l9_165;
#if (sc_IsEditor)
{
vec4 l9_166=l9_164;
l9_166.x=l9_163+(l9_57.x*1e-05);
l9_165=l9_166;
}
#else
{
...
{
vec3 l9_168=linearToneMapping(l9_165.xyz);
l9_167=vec4(l9_168.x,l9_168.y,l9_168.z,l9_165.w);
}
#else
{
l9_167=l9_165;
...
#endif
vec3 l9_169=vec3(linearToSrgb(l9_167.x),linearToSrgb(l9_167.y),linearToSrgb(l9_167.z));
l9_53=vec4(l9_169.x,l9_169.y,l9_169.z,l9_167.w);
}
#else
{
...
#endif
vec4 l9_170=max(l9_53,vec4(0.0));
vec4 l9_171;
#if (sc_ProjectiveShadowsCaster)
{
float l9_172;
...
#if (sc_BlendMode_Multiply)
{
l9_176=(1.0-dot(l9_170.xyz,vec3(0.33333)))*l9_170.w;
}
#else
{
float l9_177;
...
{
l9_181=dot(l9_170.xyz,vec3(0.33333))*l9_170.w;
}
#else
{
float l9_182;
...
{
l9_196=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_196=vec4(0.0);
...
vec4 l9_198=max(l9_197,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_200=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_200),min(1.0,l9_200+0.00392157),0.0,0.0));
}
#endif
}
#else
...
vec4 l9_210=l9_208;
l9_210.w=packValue(l9_202);
vec4 l9_212=vec4(0.0);
l9_212.x=packValue(l9_202);
vec4 l9_214=l9_212;
l9_214.y=packValue(l9_202);
vec4 l9_216=l9_214;
l9_216.z=packValue(l9_202);
vec4 l9_217=l9_216;
l9_217.w=packValue(l9_202);
int l9_218=int(l9_199.w*255.0);
float l9_219=packValue(l9_218);
vec4 l9_220=vec4(0.0);
l9_220.x=l9_219;
vec4 l9_222=l9_220;
l9_222.y=packValue(l9_218);
vec4 l9_224=l9_222;
l9_224.z=packValue(l9_218);
vec4 l9_225=l9_224;
l9_225.w=packValue(l9_218);
sc_writeFragData0(l9_217);
sc_writeFragData1(l9_210);
sc_writeFragData2(l9_225);
...
#if (sc_OITCompositingPass)
{
vec2 l9_226=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_237==0)
{
l9_240=texture2D(sc_OITAlpha0,l9_226);
l9_239=texture2D(sc_OITDepthLow0,l9_226);
l9_238=texture2D(sc_OITDepthHigh0,l9_226);
}
else
{
l9_240=l9_233;
...
if (l9_237==1)
{
l9_236=texture2D(sc_OITAlpha1,l9_226);
l9_235=texture2D(sc_OITDepthLow1,l9_226);
l9_234=texture2D(sc_OITDepthHigh1,l9_226);
}
else
{
l9_236=l9_240;
...
{
int l9_241[8]=l9_227;
unpackValues(l9_234.w,l9_237,l9_241);
unpackValues(l9_234.z,l9_237,l9_241);
unpackValues(l9_234.y,l9_237,l9_241);
unpackValues(l9_234.x,l9_237,l9_241);
unpackValues(l9_235.w,l9_237,l9_241);
unpackValues(l9_235.z,l9_237,l9_241);
unpackValues(l9_235.y,l9_237,l9_241);
unpackValues(l9_235.x,l9_237,l9_241);
int l9_250[8]=l9_228;
unpackValues(l9_236.w,l9_237,l9_250);
unpackValues(l9_236.z,l9_237,l9_250);
unpackValues(l9_236.y,l9_237,l9_250);
unpackValues(l9_236.x,l9_237,l9_250);
}
l9_233=l9_236;
l9_232=l9_235;
l9_231=l9_234;
...
vec4 l9_255=texture2D(sc_OITFilteredDepthBoundsTexture,l9_226);
vec2 l9_256=l9_255.xy;
int l9_257;
#if (sc_SkinBonesCount>0)
{
l9_257=encodeDepth(((1.0-l9_255.x)*1000.0)+getDepthOrderingEpsilon(),l9_256);
}
#else
{
l9_257=0;
...
#endif
int l9_258=encodeDepth(viewSpaceDepth(),l9_256);
vec4 l9_259;
l9_259=l9_199*l9_199.w;
vec4 l9_260;
int l9_261=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_261<8)
{
int l9_262=l9_227[l9_261];
int l9_263=l9_258-l9_257;
bool l9_264=l9_262<l9_263;
bool l9_265;
if (l9_264)
{
l9_265=l9_227[l9_261]>0;
}
else
{
l9_265=l9_264;
...
if (l9_265)
{
vec3 l9_266=l9_259.xyz*(1.0-(float(l9_228[l9_261])*0.00392157));
l9_260=vec4(l9_266.x,l9_266.y,l9_266.z,l9_259.w);
}
else
{
l9_260=l9_259;
