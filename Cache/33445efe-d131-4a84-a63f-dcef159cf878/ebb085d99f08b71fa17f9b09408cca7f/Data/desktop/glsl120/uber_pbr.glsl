...
vec3 l9_81=mix(vec3(0.04),l9_76*l9_72,l9_80);
...
#endif
l9_137=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_138,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_139;
...
#else
{
l9_139=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_136,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_137=l9_139;
}
...
l9_142=(((((((sc_Sh[8]*0.429043)*((l9_144*l9_144)-(l9_145*l9_145)))+((sc_Sh[6]*0.743125)*(l9_146*l9_146)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_144*l9_145))+(sc_Sh[7]*(l9_144*l9_146)))+(sc_Sh[5]*(l9_145*l9_146)))*0.858086))+((((sc_Sh[3]*l9_144)+(sc_Sh[1]*l9_145))+(sc_Sh[2]*l9_146))*1.02333))*sc_ShIntensity;
}
#else
{
l9_142=vec3(0.0);
...
float l9_166=0.36*l9_160;
float l9_167=0.694444*l9_165;
...
l9_158=l9_157+((((sc_LightEstimationData.sg[l9_159].color/vec3(sc_LightEstimationData.sg[l9_159].sharpness))*6.28319)*((l9_164*l9_169)+(((l9_161-l9_162)*l9_163)-l9_162)))*vec3(0.31831));
l9_157=l9_158;
l9_159++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_171=clamp(pow(l9_73,0.666667),0.0,1.0)*5.0;
...
#endif
l9_170=(((l9_173.xyz*(1.0/l9_173.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_83,abs(dot(l9_77,l9_6)));
}
#else
{
l9_170=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_177=clamp(l9_73*l9_73,0.01,1.0);
vec3 l9_178;
...
float l9_183=(2.0/l9_180)/(4.0*max(l9_182,0.0001));
...
{
vec4 l9_204=l9_202;
l9_204.x=l9_201+((l9_79.x*l9_75.x)*1e-05);
l9_203=l9_204;
}
#else
{
...
{
vec3 l9_206=linearToneMapping(l9_203.xyz);
l9_205=vec4(l9_206.x,l9_206.y,l9_206.z,l9_203.w);
}
#else
{
l9_205=l9_203;
...
#endif
vec3 l9_207=vec3(linearToSrgb(l9_205.x),linearToSrgb(l9_205.y),linearToSrgb(l9_205.z));
l9_71=vec4(l9_207.x,l9_207.y,l9_207.z,l9_205.w);
}
#else
{
...
#endif
vec4 l9_208=max(l9_71,vec4(0.0));
vec4 l9_209;
#if (sc_ProjectiveShadowsCaster)
{
float l9_210;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_211=clamp(l9_208.w*2.0,0.0,1.0);
}
#else
{
float l9_212;
...
{
l9_212=clamp(dot(l9_208.xyz,vec3(l9_208.w)),0.0,1.0);
}
#else
{
float l9_213;
...
#if (sc_BlendMode_Multiply)
{
l9_214=(1.0-dot(l9_208.xyz,vec3(0.33333)))*l9_208.w;
}
#else
{
float l9_215;
...
{
l9_215=(1.0-clamp(dot(l9_208.xyz,vec3(1.0)),0.0,1.0))*l9_208.w;
}
#else
{
float l9_216;
#if (sc_BlendMode_ColoredGlass)
{
l9_216=clamp(dot(l9_208.xyz,vec3(1.0)),0.0,1.0)*l9_208.w;
}
#else
{
float l9_217;
#if (sc_BlendMode_Add)
{
l9_217=clamp(dot(l9_208.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_218;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_218=clamp(dot(l9_208.xyz,vec3(1.0)),0.0,1.0)*l9_208.w;
}
#else
{
float l9_219;
...
{
l9_219=dot(l9_208.xyz,vec3(0.33333))*l9_208.w;
}
#else
{
float l9_220;
#if (sc_BlendMode_Min)
{
l9_220=1.0-clamp(dot(l9_208.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_221;
#if (sc_BlendMode_Max)
{
l9_221=clamp(dot(l9_208.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_221=1.0;
...
#endif
l9_209=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_208.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_210);
}
#else
{
vec4 l9_222;
...
vec3 l9_225=mix(l9_224,definedBlend(l9_224,l9_208.xyz).xyz,vec3(l9_208.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_228=l9_208.w;
l9_227=vec4(mix(vec3(1.0),l9_208.xyz,vec3(l9_228)),l9_228);
}
#else
{
vec4 l9_229;
...
#endif
l9_229=vec4(l9_208.xyz*l9_231,l9_231);
}
#else
{
l9_229=l9_208;
...
{
l9_234=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_234=vec4(0.0);
...
vec4 l9_236=max(l9_235,vec4(0.0));
sc_writeFragData0(l9_236);
vec4 l9_237=clamp(l9_236,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_238=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_238),min(1.0,l9_238+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_239=sc_ScreenCoordsGlobalToView(l9_5);
...
#endif
int l9_240=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_239).xy);
float l9_241=packValue(l9_240);
vec4 l9_242=vec4(0.0);
l9_242.x=l9_241;
vec4 l9_244=l9_242;
l9_244.y=packValue(l9_240);
vec4 l9_246=l9_244;
l9_246.z=packValue(l9_240);
vec4 l9_248=l9_246;
l9_248.w=packValue(l9_240);
vec4 l9_250=vec4(0.0);
l9_250.x=packValue(l9_240);
vec4 l9_252=l9_250;
l9_252.y=packValue(l9_240);
vec4 l9_254=l9_252;
l9_254.z=packValue(l9_240);
vec4 l9_255=l9_254;
l9_255.w=packValue(l9_240);
int l9_256=int(l9_237.w*255.0);
float l9_257=packValue(l9_256);
vec4 l9_258=vec4(0.0);
l9_258.x=l9_257;
vec4 l9_260=l9_258;
l9_260.y=packValue(l9_256);
vec4 l9_262=l9_260;
l9_262.z=packValue(l9_256);
vec4 l9_263=l9_262;
l9_263.w=packValue(l9_256);
sc_writeFragData0(l9_255);
sc_writeFragData1(l9_248);
sc_writeFragData2(l9_263);
...
#if (sc_OITCompositingPass)
{
vec2 l9_264=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_275==0)
{
l9_278=texture2D(sc_OITAlpha0,l9_264);
l9_277=texture2D(sc_OITDepthLow0,l9_264);
l9_276=texture2D(sc_OITDepthHigh0,l9_264);
}
else
{
l9_278=l9_271;
...
if (l9_275==1)
{
l9_274=texture2D(sc_OITAlpha1,l9_264);
l9_273=texture2D(sc_OITDepthLow1,l9_264);
l9_272=texture2D(sc_OITDepthHigh1,l9_264);
}
else
{
l9_274=l9_278;
...
{
int l9_279[8]=l9_265;
unpackValues(l9_272.w,l9_275,l9_279);
unpackValues(l9_272.z,l9_275,l9_279);
unpackValues(l9_272.y,l9_275,l9_279);
unpackValues(l9_272.x,l9_275,l9_279);
unpackValues(l9_273.w,l9_275,l9_279);
unpackValues(l9_273.z,l9_275,l9_279);
unpackValues(l9_273.y,l9_275,l9_279);
unpackValues(l9_273.x,l9_275,l9_279);
int l9_288[8]=l9_266;
unpackValues(l9_274.w,l9_275,l9_288);
unpackValues(l9_274.z,l9_275,l9_288);
unpackValues(l9_274.y,l9_275,l9_288);
unpackValues(l9_274.x,l9_275,l9_288);
}
l9_271=l9_274;
l9_270=l9_273;
l9_269=l9_272;
...
vec4 l9_293=texture2D(sc_OITFilteredDepthBoundsTexture,l9_264);
...
if (l9_303)
{
vec3 l9_304=l9_297.xyz*(1.0-(float(l9_266[l9_299])*0.00392157));
