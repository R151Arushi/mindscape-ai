...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_0=vec4(pow(value.x,0.454545),pow(value.y,0.454545),pow(value.z,0.454545),pow(value.w,0.454545));
}
#else
{
l9_0=sqrt(value);
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_0=vec3(pow(value.x,0.454545),pow(value.y,0.454545),pow(value.z,0.454545));
}
#else
{
l9_0=sqrt(value);
...
{
return ((2.0+(1.0/roughness))*ssPow(1.0-(NdotH*NdotH),0.5/roughness))*0.159155;
}
...
{
if (opacity<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
{
specColor=mix(vec3(0.04),surfaceProperties.albedo*surfaceProperties.metallic,vec3(surfaceProperties.metallic));
...
{
return ((((((L22*0.429043)*((n.x*n.x)-(n.y*n.y)))+((L20*0.743125)*(n.z*n.z)))+(L00*0.886227))-(L20*0.247708))+((((L2_2*(n.x*n.y))+(L21*(n.x*n.z)))+(L2_1*(n.y*n.z)))*0.858086))+((((L11*n.x)+(L1_1*n.y))+(L10*n.z))*1.02333);
}
...
{
return ((sampleSpecularEnvTextureLod(getSpecularDominantDir(surfaceProperties.normal,reflect(-V,surfaceProperties.normal),surfaceProperties.roughness),clamp(pow(surfaceProperties.roughness,0.666667),0.0,1.0)*5.0)*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(surfaceProperties,abs(dot(surfaceProperties.normal,V)));
}
sc_SphericalGaussianLight_t DistributionTermSG(vec3 direction,float roughness)
{
float l9_0=roughness*roughness;
return sc_SphericalGaussianLight_t(vec3(0.31831/l9_0),2.0/l9_0,direction);
}
sc_SphericalGaussianLight_t WarpDistributionSG(sc_SphericalGaussianLight_t ndf,vec3 view)
{
return sc_SphericalGaussianLight_t(ndf.color,ndf.sharpness/(4.0*max(dot(ndf.axis,view),0.0001)),reflect(-view,ndf.axis));
}
...
return ((((lhs.color*exp((l9_0-lhs.sharpness)-rhs.sharpness))*rhs.color)*6.28319)*(1.0-exp((-2.0)*l9_0)))/vec3(l9_0);
}
...
{
l9_2+=SpecularTermSG(sc_LightEstimationData.sg[l9_3],surfaceProperties.normal,clamp(l9_0*l9_1,0.01,1.0),V,surfaceProperties.specColor);
l9_3++;
continue;
}
else
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
l9_0=calculateIndirectSpecularEnvmap(surfaceProperties,V);
}
#else
{
l9_0=vec3(0.0);
...
{
vec4 l9_28=l9_26;
l9_28.x=l9_25+((l9_13.x*l9_12.x)*1e-05);
l9_27=l9_28;
}
#else
{
...
float l9_51=max(clamp(l9_50,0.0,1.0),0.0001);
...
if (l9_54)
{
l9_55=(((-339.2)*l9_52)+(161.4*l9_47))-25.9;
}
else
{
l9_55=(((-8.48)*l9_52)+(14.3*l9_47))-9.95;
}
float l9_56;
if (l9_54)
{
l9_56=((44.0*l9_52)-(23.7*l9_47))+3.26;
}
else
{
l9_56=((1.97*l9_52)-(3.27*l9_47))+0.72;
}
...
vec3 l9_61=sampleSpecularEnvTextureLod(normalize(l9_53),3.0+(l9_47*1.6));
vec3 l9_62=((l9_61*sc_EnvmapExposure)+vec3(1e-06))*l9_39;
vec3 l9_63=(l9_62*clamp(l9_60*3.14159,0.0,1.0)).xyz;
vec3 l9_64;
#if (sc_DirectionalLightsCount>0)
{
vec3 l9_65;
...
l9_66=l9_65+(((((l9_71*3.14159)*l9_39)*N3_charlieD(l9_52,clamp(dot(l9_10,normalize(l9_73+l9_49)),0.0,1.0)))*(0.25/((l9_74+l9_51)-(l9_74*l9_51))))*l9_74);
l9_65=l9_66;
l9_67++;
continue;
}
...
l9_77=l9_76+(((((l9_82*3.14159)*l9_39)*N3_charlieD(l9_52,clamp(dot(l9_10,normalize(l9_84+l9_49)),0.0,1.0)))*(0.25/((l9_85+l9_51)-(l9_85*l9_51))))*l9_85);
l9_76=l9_77;
l9_78++;
continue;
}
...
l9_88=l9_87+(((l9_91*l9_92)*vec3(0.31831))*l9_39);
l9_87=l9_88;
l9_89++;
continue;
}
...
l9_94.w=1.0-(max(max(l9_39.x,l9_39.y),l9_39.z)*0.157);
l9_38=l9_94;
}
#else
{
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_115=ngsCalculateLighting(l9_114,l9_113,l9_112,Globals.PositionWS,Globals.ViewDirWS,max(l9_37,vec3(0.0)),clamp(l9_14,0.0,1.0),clamp(l9_16,0.0,1.0),clamp(l9_15.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#else
{
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_118=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_117,Globals.PositionWS,Globals.ViewDirWS,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_97,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#else
{
l9_118=vec4(Port_Albedo_N405,Port_Opacity_N405);
}
#endif
...
#if (sc_BlendMode_Multiply)
{
l9_12=(1.0-dot(l9_6.xyz,vec3(0.33333)))*l9_6.w;
}
#else
{
float l9_13;
...
{
l9_17=dot(l9_6.xyz,vec3(0.33333))*l9_6.w;
}
#else
{
float l9_18;
...
{
l9_30=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_30=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_34=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_34),min(1.0,l9_34+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_38.x=l9_37;
vec4 l9_40=l9_38;
l9_40.y=packValue(l9_36);
vec4 l9_42=l9_40;
l9_42.z=packValue(l9_36);
vec4 l9_44=l9_42;
l9_44.w=packValue(l9_36);
vec4 l9_46=vec4(0.0);
l9_46.x=packValue(l9_36);
vec4 l9_48=l9_46;
l9_48.y=packValue(l9_36);
vec4 l9_50=l9_48;
l9_50.z=packValue(l9_36);
vec4 l9_51=l9_50;
l9_51.w=packValue(l9_36);
int l9_52=int(l9_33.w*255.0);
...
vec4 l9_59=l9_58;
l9_59.w=packValue(l9_52);
sc_writeFragData0(l9_51);
sc_writeFragData1(l9_44);
sc_writeFragData2(l9_59);
...
#if (sc_OITCompositingPass)
{
vec2 l9_60=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_71==0)
{
l9_74=texture2D(sc_OITAlpha0,l9_60);
l9_73=texture2D(sc_OITDepthLow0,l9_60);
l9_72=texture2D(sc_OITDepthHigh0,l9_60);
}
else
{
l9_74=l9_67;
...
if (l9_71==1)
{
l9_70=texture2D(sc_OITAlpha1,l9_60);
l9_69=texture2D(sc_OITDepthLow1,l9_60);
l9_68=texture2D(sc_OITDepthHigh1,l9_60);
}
else
{
l9_70=l9_74;
...
{
int l9_75[8]=l9_61;
unpackValues(l9_68.w,l9_71,l9_75);
unpackValues(l9_68.z,l9_71,l9_75);
unpackValues(l9_68.y,l9_71,l9_75);
unpackValues(l9_68.x,l9_71,l9_75);
unpackValues(l9_69.w,l9_71,l9_75);
unpackValues(l9_69.z,l9_71,l9_75);
unpackValues(l9_69.y,l9_71,l9_75);
unpackValues(l9_69.x,l9_71,l9_75);
int l9_84[8]=l9_62;
unpackValues(l9_70.w,l9_71,l9_84);
unpackValues(l9_70.z,l9_71,l9_84);
unpackValues(l9_70.y,l9_71,l9_84);
unpackValues(l9_70.x,l9_71,l9_84);
}
l9_67=l9_70;
l9_66=l9_69;
l9_65=l9_68;
...
vec4 l9_89=texture2D(sc_OITFilteredDepthBoundsTexture,l9_60);
vec2 l9_90=l9_89.xy;
int l9_91;
#if (sc_SkinBonesCount>0)
{
...
if (l9_99)
{
vec3 l9_100=l9_93.xyz*(1.0-(float(l9_62[l9_95])*0.00392157));
