...
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0);
}
#endif
float l9_59=l9_51;
float l9_60=1.0;
sc_ClampUV(l9_59,intensityTextureUvMinMax.x,intensityTextureUvMinMax.z,l9_58,l9_60);
vec2 l9_61=l9_55;
l9_61.x=l9_59;
float l9_62=l9_60;
bool l9_63;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y==3;
}
#else
{
l9_63=(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0);
}
#endif
float l9_64=l9_54;
float l9_65=l9_62;
sc_ClampUV(l9_64,intensityTextureUvMinMax.y,intensityTextureUvMinMax.w,l9_63,l9_65);
vec2 l9_66=l9_61;
l9_66.y=l9_64;
l9_57=l9_65;
l9_56=l9_66;
...
{
l9_67=vec2((intensityTextureTransform*vec3(l9_56,1.0)).xy);
}
#else
{
l9_67=l9_56;
...
float l9_68=l9_67.x;
float l9_69=l9_57;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_intensityTexture)!=0)),l9_69);
vec2 l9_70=l9_67;
l9_70.x=l9_68;
float l9_71=l9_67.y;
float l9_72=l9_69;
sc_SoftwareWrapLate(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_intensityTexture)!=0)),l9_72);
vec2 l9_73=l9_70;
l9_73.y=l9_71;
float l9_74=l9_72;
vec4 l9_75=sc_SampleView(intensityTextureDims.xy,l9_73,intensityTextureLayout,l9_49,0.0,intensityTexture);
vec4 l9_76;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_76=mix(intensityTextureBorderColor,l9_75,vec4(l9_74));
}
#else
{
l9_76=l9_75;
...
#endif
float l9_77=(((l9_76.x*256.0)+l9_76.y)+(l9_76.z*0.00390625))*0.0622559;
float l9_78;
...
#endif
return transformColor(l9_47,l9_45,l9_46,1.0,l9_79);
}
#endif
}
#endif
...
float l9_3=l9_0*Port_Value_N001;
float l9_4=mod(l9_3+(length((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz)*(1.0/Port_Value_N000)),Port_Value_N003);
float l9_5=((1.0-l9_4)*l9_4)*Port_Input2_N036;
float l9_6;
if (l9_5<=0.0)
{
l9_6=0.0;
...
{
l9_6=pow(l9_5,Port_Import_N037);
}
vec4 l9_7=vec4(l9_6);
vec3 l9_8=-l9_2;
vec3 l9_9;
...
#endif
vec3 l9_10=max(Port_Value_N014.xyz,vec3(0.0));
vec4 l9_11;
#if (!sc_ProjectiveShadowsCaster)
{
vec3 l9_12=ssSRGB_to_Linear(l9_10);
vec3 l9_13=normalize(l9_9);
vec3 l9_14=ssSRGB_to_Linear(max((mix(Port_Value_N008,Port_Value_N016,l9_7)*vec4(max(pow(1.0-abs(dot(l9_8,l9_1)),Port_Exponent_N007),0.0)*Port_Intensity_N007)).xyz,vec3(0.0)));
vec3 l9_15;
#if (sc_SSAOEnabled)
{
...
#endif
vec3 l9_16=vec3(Port_Metallic_N006);
vec3 l9_17=mix(vec3(0.04),l9_12*Port_Metallic_N006,l9_16);
vec3 l9_18=mix(l9_12*(1.0-Port_Metallic_N006),vec3(0.0),l9_16);
SurfaceProperties l9_19=SurfaceProperties(l9_18,Port_Opacity_N006,l9_13,varPos,l9_2,Port_Metallic_N006,Port_Roughness_N006,l9_14,l9_15,Port_SpecularAO_N006,vec3(1.0),l9_17);
vec4 l9_20=vec4(1.0);
vec3 l9_21;
vec3 l9_22;
vec3 l9_23;
...
{
LightingComponents l9_40=accumulateLight(LightingComponents(l9_28,l9_29,l9_34,l9_33,l9_31,l9_30),LightProperties(sc_DirectionalLights[l9_39].direction,sc_DirectionalLights[l9_39].color.xyz,sc_DirectionalLights[l9_39].color.w*l9_20[(l9_32<3) ? l9_32 : 3]),l9_19,l9_2);
...
l9_50=l9_58+1;
LightingComponents l9_65=accumulateLight(LightingComponents(l9_44,l9_45,l9_49,l9_48,l9_47,l9_46),LightProperties(l9_60,sc_PointLights[l9_57].color.xyz,l9_64),l9_19,l9_2);
...
#endif
l9_73=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_74,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_75;
...
#else
{
l9_75=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_72,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_73=l9_75;
}
...
float l9_81=l9_79.y;
float l9_82=l9_79.z;
l9_78=(((((((sc_Sh[8]*0.429043)*((l9_80*l9_80)-(l9_81*l9_81)))+((sc_Sh[6]*0.743125)*(l9_82*l9_82)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_80*l9_81))+(sc_Sh[7]*(l9_80*l9_82)))+(sc_Sh[5]*(l9_81*l9_82)))*0.858086))+((((sc_Sh[3]*l9_80)+(sc_Sh[1]*l9_81))+(sc_Sh[2]*l9_82))*1.02333))*sc_ShIntensity;
}
#else
{
l9_78=vec3(0.0);
...
float l9_102=0.36*l9_96;
float l9_103=0.694444*l9_101;
...
l9_94=l9_93+((((sc_LightEstimationData.sg[l9_95].color/vec3(sc_LightEstimationData.sg[l9_95].sharpness))*6.28319)*((l9_100*l9_105)+(((l9_97-l9_98)*l9_99)-l9_98)))*vec3(0.31831));
l9_93=l9_94;
l9_95++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_107=clamp(pow(Port_Roughness_N006,0.666667),0.0,1.0)*5.0;
vec2 l9_108=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_13,reflect(l9_8,l9_13),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_109;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_106=(((l9_109.xyz*(1.0/l9_109.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_19,abs(dot(l9_13,l9_2)));
}
#else
{
l9_106=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_113=clamp(Port_Roughness_N006*Port_Roughness_N006,0.01,1.0);
vec3 l9_114;
...
vec3 l9_117=reflect(l9_8,l9_13);
float l9_118=dot(l9_13,l9_2);
float l9_119=(2.0/l9_116)/(4.0*max(l9_118,0.0001));
...
l9_114+=((((((((vec3(0.31831/l9_116)*exp((l9_120-l9_119)-sc_LightEstimationData.sg[l9_115].sharpness))*sc_LightEstimationData.sg[l9_115].color)*6.28319)*(1.0-exp((-2.0)*l9_120)))/vec3(l9_120))*((1.0/(l9_121+sqrt(l9_116+((l9_123*l9_121)*l9_121))))*(1.0/(l9_122+sqrt(l9_116+((l9_123*l9_122)*l9_122))))))*(l9_17+((vec3(1.0)-l9_17)*pow(1.0-clamp(dot(l9_117,normalize(l9_117+l9_2)),0.0,1.0),5.0))))*l9_121);
l9_115++;
continue;
}
else
...
{
vec4 l9_140=l9_138;
l9_140.x=l9_137+((l9_15.x*Port_SpecularAO_N006.x)*1e-05);
l9_139=l9_140;
}
#else
{
...
{
vec3 l9_142=linearToneMapping(l9_139.xyz);
l9_141=vec4(l9_142.x,l9_142.y,l9_142.z,l9_139.w);
}
#else
{
l9_141=l9_139;
...
#endif
vec3 l9_143=vec3(linearToSrgb(l9_141.x),linearToSrgb(l9_141.y),linearToSrgb(l9_141.z));
l9_11=vec4(l9_143.x,l9_143.y,l9_143.z,l9_141.w);
}
#else
{
l9_11=vec4(l9_10,Port_Opacity_N006);
}
#endif
vec4 l9_144=max(l9_11,vec4(0.0));
vec4 l9_145;
#if (sc_ProjectiveShadowsCaster)
{
float l9_146;
...
#if (sc_BlendMode_Multiply)
{
l9_150=(1.0-dot(l9_144.xyz,vec3(0.33333)))*l9_144.w;
}
#else
{
float l9_151;
...
{
l9_155=dot(l9_144.xyz,vec3(0.33333))*l9_144.w;
}
#else
{
float l9_156;
...
{
l9_170=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_170=vec4(0.0);
...
vec4 l9_172=max(l9_171,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_174=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_174),min(1.0,l9_174+0.00392157),0.0,0.0));
}
#endif
}
#else
...
vec4 l9_178=vec4(0.0);
l9_178.x=l9_177;
vec4 l9_180=l9_178;
l9_180.y=packValue(l9_176);
vec4 l9_182=l9_180;
l9_182.z=packValue(l9_176);
vec4 l9_184=l9_182;
l9_184.w=packValue(l9_176);
vec4 l9_186=vec4(0.0);
l9_186.x=packValue(l9_176);
vec4 l9_188=l9_186;
l9_188.y=packValue(l9_176);
vec4 l9_190=l9_188;
l9_190.z=packValue(l9_176);
vec4 l9_191=l9_190;
l9_191.w=packValue(l9_176);
int l9_192=int(l9_173.w*255.0);
float l9_193=packValue(l9_192);
vec4 l9_194=vec4(0.0);
l9_194.x=l9_193;
vec4 l9_196=l9_194;
l9_196.y=packValue(l9_192);
vec4 l9_198=l9_196;
l9_198.z=packValue(l9_192);
vec4 l9_199=l9_198;
l9_199.w=packValue(l9_192);
sc_writeFragData0(l9_191);
sc_writeFragData1(l9_184);
sc_writeFragData2(l9_199);
...
#if (sc_OITCompositingPass)
{
vec2 l9_200=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_211==0)
{
l9_214=texture2D(sc_OITAlpha0,l9_200);
l9_213=texture2D(sc_OITDepthLow0,l9_200);
l9_212=texture2D(sc_OITDepthHigh0,l9_200);
}
else
{
l9_214=l9_207;
...
if (l9_211==1)
{
l9_210=texture2D(sc_OITAlpha1,l9_200);
l9_209=texture2D(sc_OITDepthLow1,l9_200);
l9_208=texture2D(sc_OITDepthHigh1,l9_200);
}
else
{
l9_210=l9_214;
...
if (any(notEqual(l9_208,vec4(0.0)))||any(notEqual(l9_209,vec4(0.0))))
{
int l9_215[8]=l9_201;
unpackValues(l9_208.w,l9_211,l9_215);
unpackValues(l9_208.z,l9_211,l9_215);
unpackValues(l9_208.y,l9_211,l9_215);
unpackValues(l9_208.x,l9_211,l9_215);
unpackValues(l9_209.w,l9_211,l9_215);
unpackValues(l9_209.z,l9_211,l9_215);
unpackValues(l9_209.y,l9_211,l9_215);
unpackValues(l9_209.x,l9_211,l9_215);
int l9_224[8]=l9_202;
unpackValues(l9_210.w,l9_211,l9_224);
unpackValues(l9_210.z,l9_211,l9_224);
unpackValues(l9_210.y,l9_211,l9_224);
unpackValues(l9_210.x,l9_211,l9_224);
}
l9_207=l9_210;
l9_206=l9_209;
l9_205=l9_208;
...
vec4 l9_229=texture2D(sc_OITFilteredDepthBoundsTexture,l9_200);
...
if (l9_239)
{
vec3 l9_240=l9_233.xyz*(1.0-(float(l9_202[l9_235])*0.00392157));
