...
{
l9_34=(1.0-dot(l9_28.xyz,vec3(0.33333)))*l9_27;
}
#else
{
float l9_35;
...
{
l9_39=dot(l9_28.xyz,vec3(0.33333))*l9_27;
}
#else
{
float l9_40;
...
{
l9_59=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_59=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_63=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_63),min(1.0,l9_63+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_67.x=l9_66;
vec4 l9_69=l9_67;
l9_69.y=packValue(l9_65);
vec4 l9_71=l9_69;
l9_71.z=packValue(l9_65);
vec4 l9_73=l9_71;
l9_73.w=packValue(l9_65);
vec4 l9_75=vec4(0.0);
l9_75.x=packValue(l9_65);
vec4 l9_77=l9_75;
l9_77.y=packValue(l9_65);
vec4 l9_79=l9_77;
l9_79.z=packValue(l9_65);
vec4 l9_80=l9_79;
l9_80.w=packValue(l9_65);
int l9_81=int(l9_62.w*255.0);
float l9_82=packValue(l9_81);
vec4 l9_83=vec4(0.0);
l9_83.x=l9_82;
vec4 l9_85=l9_83;
l9_85.y=packValue(l9_81);
vec4 l9_87=l9_85;
l9_87.z=packValue(l9_81);
vec4 l9_88=l9_87;
l9_88.w=packValue(l9_81);
sc_writeFragData0(l9_80);
sc_writeFragData1(l9_73);
sc_writeFragData2(l9_88);
...
#if (sc_OITCompositingPass)
{
vec2 l9_89=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_100==0)
{
l9_103=texture2D(sc_OITAlpha0,l9_89);
l9_102=texture2D(sc_OITDepthLow0,l9_89);
l9_101=texture2D(sc_OITDepthHigh0,l9_89);
}
else
{
l9_103=l9_96;
...
if (l9_100==1)
{
l9_99=texture2D(sc_OITAlpha1,l9_89);
l9_98=texture2D(sc_OITDepthLow1,l9_89);
l9_97=texture2D(sc_OITDepthHigh1,l9_89);
}
else
{
l9_99=l9_103;
...
{
int l9_104[8]=l9_90;
unpackValues(l9_97.w,l9_100,l9_104);
unpackValues(l9_97.z,l9_100,l9_104);
unpackValues(l9_97.y,l9_100,l9_104);
unpackValues(l9_97.x,l9_100,l9_104);
unpackValues(l9_98.w,l9_100,l9_104);
unpackValues(l9_98.z,l9_100,l9_104);
unpackValues(l9_98.y,l9_100,l9_104);
unpackValues(l9_98.x,l9_100,l9_104);
int l9_113[8]=l9_91;
unpackValues(l9_99.w,l9_100,l9_113);
unpackValues(l9_99.z,l9_100,l9_113);
unpackValues(l9_99.y,l9_100,l9_113);
unpackValues(l9_99.x,l9_100,l9_113);
}
l9_96=l9_99;
l9_95=l9_98;
l9_94=l9_97;
...
vec4 l9_118=texture2D(sc_OITFilteredDepthBoundsTexture,l9_89);
...
if (l9_128)
{
vec3 l9_129=l9_122.xyz*(1.0-(float(l9_91[l9_124])*0.00392157));
