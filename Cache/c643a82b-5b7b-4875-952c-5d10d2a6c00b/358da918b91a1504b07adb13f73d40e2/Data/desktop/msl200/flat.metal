...
//ubo int UserUniforms 2:28:4176 {
...
//float opacityMul 3984
//float4 Port_Import_N384 4000
//float Port_Import_N307 4016
//float Port_Import_N201 4020
//float Port_Import_N010 4024
//float Port_Import_N007 4028
//float2 Port_Import_N008 4032
//float2 Port_Import_N009 4040
//float Port_Speed_N022 4048
//float Port_Import_N012 4052
//float2 Port_Import_N254 4056
//float Port_Import_N055 4064
//float Port_Import_N056 4068
//float2 Port_Import_N000 4072
//float2 Port_Import_N060 4080
//float2 Port_Import_N061 4088
//float Port_Speed_N063 4096
//float Port_Import_N065 4100
//float2 Port_Import_N255 4104
//float4 Port_Default_N369 4112
//float4 Port_Import_N166 4128
//float Port_Import_N206 4144
//float Port_Import_N043 4148
//float2 Port_Import_N151 4152
//float2 Port_Import_N155 4160
//float Port_Import_N029 4168
//float Port_Default_N204 4172
//}
...
l9_698=l9_600.x;
float l9_699=0.0;
ssGlobals l9_700=param_11;
float l9_701=(*sc_set2.UserUniforms).opacityMul;
l9_699=l9_701;
float l9_702=0.0;
l9_702=l9_699;
float l9_703=0.0;
l9_703=l9_698*l9_702;
param_8=l9_703;
param_10=param_8;
}
else
...
{
float4 l9_704=gl_FragCoord;
float2 l9_705=floor(mod(l9_704.xy,float2(4.0)));
float l9_706=(mod(dot(l9_705,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_12<l9_706)
{
discard_fragment();
}
...
{
l9_709=fast::clamp(l9_708.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_709=fast::clamp(dot(l9_708.xyz,float3(l9_708.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_709=(1.0-dot(l9_708.xyz,float3(0.33333)))*l9_708.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_709=(1.0-fast::clamp(dot(l9_708.xyz,float3(1.0)),0.0,1.0))*l9_708.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_709=fast::clamp(dot(l9_708.xyz,float3(1.0)),0.0,1.0)*l9_708.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_709=fast::clamp(dot(l9_708.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_709=dot(l9_708.xyz,float3(0.33333))*l9_708.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_709=1.0-fast::clamp(dot(l9_708.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_710=l9_709;
float l9_711=l9_710;
float l9_712=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_711;
float3 l9_713=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_707.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_714=float4(l9_713.x,l9_713.y,l9_713.z,l9_712);
param_13=l9_714;
}
else
{
...
{
float4 l9_715=param_13;
float4 l9_716;
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_717=out.FragColor0;
float4 l9_718=l9_717;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_718.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_721=(l9_720.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
float2 l9_722=l9_721;
float2 l9_723;
if (sc_StereoRenderingMode_tmp==1)
{
float3 l9_724=float3(l9_722,0.0);
int l9_725=1;
int l9_726;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_727=l9_726;
int l9_728=l9_727;
float3 l9_729=float3(l9_722,0.0);
int l9_730=l9_725;
int l9_731=l9_728;
if (l9_730==1)
{
l9_729.y=((2.0*l9_729.y)+float(l9_731))-1.0;
}
float2 l9_732=l9_729.xy;
l9_723=l9_732;
}
else
{
...
int l9_745=l9_743;
float l9_746=0.0;
float2 l9_747=(*sc_set2.UserUniforms).sc_ScreenTextureDims.xy;
float2 l9_748=l9_747;
float2 l9_749=l9_744;
int l9_750=sc_ScreenTextureLayout_tmp;
int l9_751=l9_745;
float l9_752=l9_746;
...
if (l9_754==0)
{
l9_756=float3(l9_753,0.0);
}
else
{
if (l9_754==1)
{
l9_756=float3(l9_753.x,(l9_753.y*0.5)+(0.5-(float(l9_755)*0.5)),0.0);
}
else
{
l9_756=float3(l9_753,float(l9_755));
}
}
float3 l9_757=l9_756;
float3 l9_758=l9_757;
float2 l9_759=l9_748;
float2 l9_760=l9_758.xy;
float l9_761=l9_752;
float4 l9_762=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_760,bias(l9_761));
...
float4 l9_768=l9_716;
float4 l9_769=l9_768;
float3 l9_770=l9_769.xyz;
float3 l9_771=l9_770;
float3 l9_772=l9_715.xyz;
float3 l9_773=definedBlend(l9_771,l9_772,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
float4 l9_774;
l9_774=float4(l9_773.x,l9_773.y,l9_773.z,l9_774.w);
float3 l9_775=mix(l9_770,l9_774.xyz,float3(l9_715.w));
l9_774=float4(l9_775.x,l9_775.y,l9_775.z,l9_774.w);
l9_774.w=1.0;
float4 l9_776=l9_774;
param_13=l9_776;
}
else
{
float4 l9_777=param_13;
float4 l9_778;
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
...
{
l9_782=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_782=float4(0.0);
