...
float l9_0=mod(varPackedTex.y,0.25);
float l9_1=mod(varPackedTex.y,0.125);
float l9_2=mod(varPackedTex.y,0.025);
float l9_3=(clamp(((clamp(((float(min(l9_0,0.25-l9_0)<(0.003*widthScale))*step(varPackedTex.x,0.35))+(float(min(l9_1,0.125-l9_1)<(0.0025*widthScale))*step(varPackedTex.x,0.25)))+0.001,0.001,1.001)-0.001)+(float(min(l9_2,0.025-l9_2)<(0.0015*widthScale))*step(varPackedTex.x,0.15)))+0.001,0.001,1.001)-0.001)*colorjs.w;
vec4 l9_4=vec4(0.0);
l9_4.x=colorjs.x;
vec4 l9_5=l9_4;
l9_5.y=colorjs.y;
