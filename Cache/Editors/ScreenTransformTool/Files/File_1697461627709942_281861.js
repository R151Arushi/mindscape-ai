...
// @input SceneObject enableSnappingObj 
checkUndefined("enableSnappingObj", undefined, undefined);
// @input SceneObject disableSnappingObj 
checkUndefined("disableSnappingObj", undefined, undefined);
var RequireModule = require("RequireModule");
if (false) {
	 require("../../../../../Modules/Src/Editor/Tools/Snapping");
}
var Module = RequireModule.requireModule("../../../../../Modules/Src/Editor/Tools/Snapping");
script.instance = new Module.module.Snapping();
script.instance.camera = script.camera
script.instance.hintObj = script.hintObj
script.instance.enableSnappingObj = script.enableSnappingObj
script.instance.disableSnappingObj = script.disableSnappingObj
...
Object.defineProperty(script, 'enableSnappingObj', { get: function() { return script.instance.enableSnappingObj; }, set: function(x) { script.instance.enableSnappingObj = x }});
Object.defineProperty(script, 'disableSnappingObj', { get: function() { return script.instance.disableSnappingObj; }, set: function(x) { script.instance.disableSnappingObj = x }});
