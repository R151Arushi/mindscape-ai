...
//sampler sampler Tweak_N0SmpSC 2:11
//sampler sampler Tweak_N1SmpSC 2:12
//sampler sampler intensityTextureSmpSC 2:13
//sampler sampler sc_OITCommonSampler 2:14
//texture texture2D Tweak_N0 2:0:2:11
//texture texture2D Tweak_N1 2:1:2:12
...
vec3 l9_3=varNormal;
vec2 l9_4=vec2(0.0);
l9_4.x=fract(((floor(float(sc_GetLocalInstanceID())+0.5)*2.0)+1.0)/(Tweak_N1Size.x*2.0));
vec2 l9_5=l9_4;
l9_5.y=(((floor(float(sc_GetLocalInstanceID())+0.5)/Tweak_N1Size.y)*2.0)+1.0)/(Tweak_N1Size.y*2.0);
int l9_6;
...
#endif
vec4 l9_9=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,l9_8,l9_5,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0);
vec3 l9_10=l9_9.xyz;
vec3 l9_11=l9_7.xyz-l9_10;
vec3 l9_12=vec3(0.0);
l9_12.x=l9_11.y;
vec3 l9_13=l9_12;
l9_13.y=-l9_11.x;
...
sc_Vertex_t param_24=l9_1;
ngsVertexShaderEnd(param_24,(((l9_14*l9_16)*vec3(l9_1.texture0.x+(-0.5)))*vec3(width))+(l9_10+(l9_11*vec3(l9_1.texture0.y))),l9_3,varTangent.xyz,l9_1.position);
}
...
#endif
vec4 l9_0=ngsPixelShader(baseColor);
vec4 l9_1=max(l9_0,vec4(0.0));
sc_writeFragData0(l9_1);
vec4 l9_2=clamp(l9_1,vec4(0.0),vec4(1.0));
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_3=varViewSpaceDepth;
}
#else
{
l9_3=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_4=clamp(l9_3*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_4),min(1.0,l9_4+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_5=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_6;
#if (sc_SkinBonesCount>0)
{
l9_6=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_5.x)>l9_6)
{
discard;
}
