...
vec4 l9_71=mix(mix(l9_62,vec4(shapeColor.xyz,1.0),vec4(clamp(((((l9_69+l9_70)-max(l9_69,l9_70))+l9_70)*(-1.0))+1.0,0.0,1.0))),strokeColor,vec4(l9_69));
float l9_72=l9_71.w;
...
{
if (l9_72<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_73=ngsPixelShader(l9_71);
vec4 l9_74=max(l9_73,vec4(0.0));
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_76=varViewSpaceDepth;
}
#else
{
l9_76=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_77=clamp(l9_76*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_77),min(1.0,l9_77+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
oitDepthGather(l9_75);
}
#else
{
#if (sc_OITCompositingPass)
{
oitCompositing(l9_75);
}
#else
{
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_78=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_79;
#if (sc_SkinBonesCount>0)
{
l9_79=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_78.x)>l9_79)
{
discard;
}
