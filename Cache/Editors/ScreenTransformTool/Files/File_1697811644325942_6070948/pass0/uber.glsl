...
//sampler sampler active_txtSmpSC 2:13
//sampler sampler inactive_txtSmpSC 2:14
//sampler sampler intensityTextureSmpSC 2:15
//sampler sampler sc_OITCommonSampler 2:16
//texture texture2D active_txt 2:0:2:13
//texture texture2D inactive_txt 2:1:2:14
//texture texture2D intensityTexture 2:2:2:15
//texture texture2D sc_OITAlpha0 2:3:2:16
//texture texture2D sc_OITAlpha1 2:4:2:16
//texture texture2D sc_OITDepthHigh0 2:5:2:16
//texture texture2D sc_OITDepthHigh1 2:6:2:16
//texture texture2D sc_OITDepthLow0 2:7:2:16
//texture texture2D sc_OITDepthLow1 2:8:2:16
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:9:2:16
//texture texture2D sc_OITFrontDepthTexture 2:10:2:16
//SG_REFLECTION_END
...
uniform vec4 active_txtDims;
uniform vec4 inactive_txtDims;
...
uniform vec4 active_txtSize;
uniform vec4 active_txtView;
uniform mat3 active_txtTransform;
uniform vec4 active_txtUvMinMax;
uniform vec4 active_txtBorderColor;
uniform vec4 inactive_txtSize;
uniform vec4 inactive_txtView;
uniform mat3 inactive_txtTransform;
uniform vec4 inactive_txtUvMinMax;
uniform vec4 inactive_txtBorderColor;
...
#endif
#ifndef active_txtHasSwappedViews
#define active_txtHasSwappedViews 0
#elif active_txtHasSwappedViews==1
#undef active_txtHasSwappedViews
#define active_txtHasSwappedViews 1
#endif
#ifndef active_txtLayout
#define active_txtLayout 0
#endif
#ifndef inactive_txtHasSwappedViews
#define inactive_txtHasSwappedViews 0
#elif inactive_txtHasSwappedViews==1
#undef inactive_txtHasSwappedViews
#define inactive_txtHasSwappedViews 1
#endif
#ifndef inactive_txtLayout
#define inactive_txtLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_active_txt
#define SC_USE_UV_TRANSFORM_active_txt 0
#elif SC_USE_UV_TRANSFORM_active_txt==1
#undef SC_USE_UV_TRANSFORM_active_txt
#define SC_USE_UV_TRANSFORM_active_txt 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_active_txt
#define SC_SOFTWARE_WRAP_MODE_U_active_txt -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_active_txt
#define SC_SOFTWARE_WRAP_MODE_V_active_txt -1
#endif
#ifndef SC_USE_UV_MIN_MAX_active_txt
#define SC_USE_UV_MIN_MAX_active_txt 0
#elif SC_USE_UV_MIN_MAX_active_txt==1
#undef SC_USE_UV_MIN_MAX_active_txt
#define SC_USE_UV_MIN_MAX_active_txt 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_active_txt
#define SC_USE_CLAMP_TO_BORDER_active_txt 0
#elif SC_USE_CLAMP_TO_BORDER_active_txt==1
#undef SC_USE_CLAMP_TO_BORDER_active_txt
#define SC_USE_CLAMP_TO_BORDER_active_txt 1
#endif
#ifndef SC_USE_UV_TRANSFORM_inactive_txt
#define SC_USE_UV_TRANSFORM_inactive_txt 0
#elif SC_USE_UV_TRANSFORM_inactive_txt==1
#undef SC_USE_UV_TRANSFORM_inactive_txt
#define SC_USE_UV_TRANSFORM_inactive_txt 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_inactive_txt
#define SC_SOFTWARE_WRAP_MODE_U_inactive_txt -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_inactive_txt
#define SC_SOFTWARE_WRAP_MODE_V_inactive_txt -1
#endif
#ifndef SC_USE_UV_MIN_MAX_inactive_txt
#define SC_USE_UV_MIN_MAX_inactive_txt 0
#elif SC_USE_UV_MIN_MAX_inactive_txt==1
#undef SC_USE_UV_MIN_MAX_inactive_txt
#define SC_USE_UV_MIN_MAX_inactive_txt 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_inactive_txt
#define SC_USE_CLAMP_TO_BORDER_inactive_txt 0
#elif SC_USE_CLAMP_TO_BORDER_inactive_txt==1
#undef SC_USE_CLAMP_TO_BORDER_inactive_txt
#define SC_USE_CLAMP_TO_BORDER_inactive_txt 1
#endif
uniform vec4 intensityTextureDims;
uniform float correctedIntensity;
uniform mat3 intensityTextureTransform;
...
uniform vec4 inactive_txtSize;
uniform vec4 inactive_txtView;
uniform mediump sampler2D inactive_txt;
uniform mediump sampler2D active_txt;
...
float l9_9=(shapeWidthX*l9_8)+l9_2;
float l9_10;
if (l9_6>l9_2)
{
...
float l9_12=xOffset+l9_11;
float l9_13=l9_10+(1.0-l9_12);
float l9_14=floor(float(yUpPin));
float l9_15;
if (l9_14==0.0)
{
l9_15=0.0;
...
float l9_17=floor(float(yDownPin));
bool l9_18=l9_17==0.0;
float l9_19;
if (l9_18)
{
l9_19=0.0;
...
float l9_21=l9_19-l9_15;
float l9_22=(shapeHeightY*l9_21)+l9_15;
float l9_23;
if (l9_19>l9_15)
{
l9_23=clamp(l9_22,l9_15,l9_19);
}
else
{
l9_23=clamp(l9_22,l9_19,l9_15);
}
float l9_24;
if (l9_18)
{
...
l9_25.x=l9_13;
vec2 l9_26=l9_25;
l9_26.y=l9_23+(yOffset+l9_24);
vec2 l9_27=(l9_0+l9_26)-vec2(0.5);
float l9_28=radians(shapeRotation);
float l9_29=sin(l9_28);
float l9_30=cos(l9_28);
float l9_31=clamp(shapeWidthX,0.0,1.0);
float l9_32=clamp(shapeHeightY,0.0,1.0);
vec2 l9_33=vec2(0.0);
l9_33.x=l9_31;
vec2 l9_34=l9_33;
l9_34.y=l9_32;
float l9_35=max(min(min(abs(shapeRoundness),l9_31),l9_32),0.001);
vec4 l9_36=vec4(0.5,0.5,0.5,0.0);
l9_36.w=0.0;
float l9_37=1.0-(length(max((abs(((vec2(dot(vec2(l9_30,l9_29),l9_27),dot(vec2(-l9_29,l9_30),l9_27))+vec2(0.5))*vec2(2.0))+vec2(-1.0))-l9_34)+vec2(l9_35),vec2(0.0)))/l9_35);
float l9_38=(clamp((l9_37/fwidth(l9_37))+0.001,0.001,1.001)-0.001)*shapeAlpha;
Value1=mix(l9_36,vec4(shapeColor.xyz,1.0),vec4(clamp((l9_38-max(0.0,l9_38))+l9_38,0.0,1.0)));
Result=Value1;
}
else
{
vec2 l9_39=Globals.Surface_UVCoord0;
float l9_40=floor(float(xRightPin));
float l9_41;
if (l9_40==0.0)
{
l9_41=0.0;
...
float l9_43=floor(float(xLeftPin));
bool l9_44=l9_43==0.0;
float l9_45;
if (l9_44)
{
l9_45=0.0;
...
float l9_47=l9_45-l9_41;
float l9_48=(shapeWidthX*l9_47)+l9_41;
float l9_49;
if (l9_45>l9_41)
{
l9_49=clamp(l9_48,l9_41,l9_45);
}
else
{
l9_49=clamp(l9_48,l9_45,l9_41);
}
float l9_50;
if (l9_44)
{
...
float l9_51=xOffset+l9_50;
float l9_52=l9_49+(1.0-l9_51);
float l9_53=floor(float(yUpPin));
float l9_54;
if (l9_53==0.0)
{
l9_54=0.0;
...
float l9_56=floor(float(yDownPin));
bool l9_57=l9_56==0.0;
float l9_58;
if (l9_57)
{
l9_58=0.0;
...
float l9_60=l9_58-l9_54;
float l9_61=(shapeHeightY*l9_60)+l9_54;
float l9_62;
if (l9_58>l9_54)
{
l9_62=clamp(l9_61,l9_54,l9_58);
}
else
{
l9_62=clamp(l9_61,l9_58,l9_54);
}
float l9_63;
if (l9_57)
{
...
l9_64.x=l9_52;
vec2 l9_65=l9_64;
l9_65.y=l9_62+(yOffset+l9_63);
vec2 l9_66=(l9_39+l9_65)-vec2(0.5);
float l9_67=radians(shapeRotation);
float l9_68=sin(l9_67);
float l9_69=cos(l9_67);
float l9_70=clamp(shapeWidthX,0.0,1.0);
float l9_71=clamp(shapeHeightY,0.0,1.0);
vec2 l9_72=vec2(0.0);
l9_72.x=l9_70;
vec2 l9_73=l9_72;
l9_73.y=l9_71;
float l9_74=max(min(min(abs(shapeRoundness),l9_70),l9_71),0.001);
vec4 l9_75=vec4(0.5,0.5,0.5,0.0);
l9_75.w=0.0;
float l9_76=1.0-(length(max((abs(((vec2(dot(vec2(l9_69,l9_68),l9_66),dot(vec2(-l9_68,l9_69),l9_66))+vec2(0.5))*vec2(2.0))+vec2(-1.0))-l9_73)+vec2(l9_74),vec2(0.0)))/l9_74);
float l9_77=(clamp((l9_76/fwidth(l9_76))+0.001,0.001,1.001)-0.001)*shapeAlpha;
vec4 l9_78=mix(l9_75,vec4(shapeColor.xyz,1.0),vec4(clamp((l9_77-max(0.0,l9_77))+l9_77,0.0,1.0)));
vec4 l9_79=vec4(0.0);
l9_79.x=l9_78.x;
vec4 l9_80=l9_79;
l9_80.y=l9_78.y;
...
void Node366_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Bool1=float(Active);
if (Bool1!=0.0)
{
...
#endif
Value1=sc_SampleTextureBiasOrLevel(active_txtDims.xy,active_txtLayout,l9_1,((l9_0-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_active_txt)!=0),active_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_active_txt,SC_SOFTWARE_WRAP_MODE_V_active_txt),(int(SC_USE_UV_MIN_MAX_active_txt)!=0),active_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_active_txt)!=0),active_txtBorderColor,0.0,active_txt);
Result=Value1;
}
else
{
vec2 l9_2=Globals.Surface_UVCoord0;
int l9_3;
#if (inactive_txtHasSwappedViews)
{
...
#endif
Default=sc_SampleTextureBiasOrLevel(inactive_txtDims.xy,inactive_txtLayout,l9_3,((l9_2-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_inactive_txt)!=0),inactive_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_inactive_txt,SC_SOFTWARE_WRAP_MODE_V_inactive_txt),(int(SC_USE_UV_MIN_MAX_inactive_txt)!=0),inactive_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_inactive_txt)!=0),inactive_txtBorderColor,0.0,inactive_txt);
Result=Default;
}
}
void Node5_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
bool l9_0=float(Active)!=0.0;
bool l9_1;
if (!l9_0)
{
l9_1=float(Hover)!=0.0;
}
else
{
l9_1=l9_0;
...
{
vec4 param_3;
Node366_If_else(0.0,vec4(0.0),vec4(0.0),param_3,Globals);
vec4 l9_2=vec4(0.0);
l9_2.x=0.964;
vec4 l9_3=l9_2;
l9_3.y=0.964;
...
{
vec4 param_8;
Node366_If_else(0.0,vec4(0.0),vec4(0.0),param_8,Globals);
vec4 l9_6=vec4(0.0);
l9_6.x=0.761;
vec4 l9_7=l9_6;
l9_7.y=0.82;
...
vec4 l9_4;
if (max(float(Active),float(Hover))!=0.0)
{
vec4 l9_5;
Node337_If_else(0.0,vec4(0.0),vec4(0.0),l9_5,l9_3);
l9_4=l9_5;
}
else
{
vec4 l9_6;
Node337_If_else(0.0,vec4(0.0),vec4(0.0),l9_6,l9_3);
l9_4=l9_6*vec4(1.0,1.0,1.0,0.0);
}
vec4 param_3;
Node5_If_else(0.0,vec4(0.0),vec4(0.0),param_3,l9_3);
vec3 l9_7=mix(l9_4.xyz,param_3.xyz,vec3(param_3.w));
float l9_8=clamp((l9_4.w+param_3.w)+0.001,0.001,1.001)-0.001;
