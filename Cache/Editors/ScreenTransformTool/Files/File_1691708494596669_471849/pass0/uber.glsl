...
varying vec4 varColor;
void Node17_If_else(float Bool1,float Value1,float Default,out float Result,ssGlobals Globals)
{
float l9_0=edgeSize*0.999999;
bool l9_1=float(min(Globals.Surface_UVCoord0.x,Globals.Surface_UVCoord0.y)<l9_0)!=0.0;
bool l9_2;
if (!l9_1)
{
l9_2=float((1.0-max(Globals.Surface_UVCoord0.x,Globals.Surface_UVCoord0.y))<l9_0)!=0.0;
}
else
{
l9_2=l9_1;
...
float param_3;
Node17_If_else(0.0,1.0,0.0,param_3,ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy));
float l9_3=param_3;
vec4 l9_4=vec4(0.0);
l9_4.x=baseColor.x;
vec4 l9_5=l9_4;
