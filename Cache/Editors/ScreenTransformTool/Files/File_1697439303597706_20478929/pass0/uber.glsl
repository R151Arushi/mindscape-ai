...
vec4 l9_39=mix(l9_36,vec4(shapeColor.xyz,1.0),vec4(clamp((l9_38-max(0.0,l9_38))+l9_38,0.0,1.0)));
vec4 l9_40=vec4(0.0);
l9_40.x=l9_39.x;
vec4 l9_41=l9_40;
l9_41.y=l9_39.y;
...
l9_10.z=0.871;
vec4 l9_11=l9_10;
l9_11.w=sc_SampleTextureBiasOrLevel(active_txtDims.xy,active_txtLayout,l9_7,((l9_6-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_active_txt)!=0),active_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_active_txt,SC_SOFTWARE_WRAP_MODE_V_active_txt),(int(SC_USE_UV_MIN_MAX_active_txt)!=0),active_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_active_txt)!=0),active_txtBorderColor,0.0,active_txt).w;
Default=l9_11;
Result=Default;
}
}
...
vec4 l9_7;
Node5_If_else(0.0,vec4(0.0),vec4(0.0),l9_7,l9_3);
float l9_8=l9_7.w*0.6;
vec4 l9_9=vec4(0.0);
l9_9.x=l9_7.x;
vec4 l9_10=l9_9;
l9_10.y=l9_7.y;
vec4 l9_11=l9_10;
l9_11.z=l9_7.z;
vec3 l9_12=mix(l9_4.xyz,l9_11.xyz,vec3(l9_8));
float l9_13=clamp((l9_4.w+l9_8)+0.001,0.001,1.001)-0.001;
vec4 l9_14=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_14.w=l9_13;
...
#endif
vec4 l9_15=ngsPixelShader(l9_14);
vec4 l9_16=max(l9_15,vec4(0.0));
sc_writeFragData0(l9_16);
vec4 l9_17=clamp(l9_16,vec4(0.0),vec4(1.0));
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_18=varViewSpaceDepth;
}
#else
{
l9_18=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_19=clamp(l9_18*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_19),min(1.0,l9_19+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
oitDepthGather(l9_17);
}
#else
{
#if (sc_OITCompositingPass)
{
oitCompositing(l9_17);
}
#else
{
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_20=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_21;
#if (sc_SkinBonesCount>0)
{
l9_21=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_20.x)>l9_21)
{
discard;
}
sc_writeFragData0(l9_17);
}
#endif
}
#else
