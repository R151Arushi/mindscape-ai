...
//sampler sampler active_txtSmpSC 2:11
//sampler sampler baseTexSmpSC 2:12
//sampler sampler intensityTextureSmpSC 2:13
//sampler sampler sc_OITCommonSampler 2:14
//texture texture2D active_txt 2:0:2:11
//texture texture2D baseTex 2:1:2:12
...
vec2 l9_1=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_2=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.0005)>0.0;
bool l9_3;
if (l9_2)
{
l9_3=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.0005)<0.0;
}
else
{
l9_3=l9_2;
...
if (!l9_3)
{
l9_4=l9_1*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y*10.0);
}
else
{
l9_4=l9_1;
}
float l9_5=min(min(borderScale,l9_4.x*0.5),l9_4.y*0.5);
float l9_6=(baseTexSize.x/baseTexSize.y)*l9_5;
float l9_7=((sliceSizeLeft*l9_6)*2.0)/l9_4.x;
float l9_8=((sliceSizeRight*l9_6)*2.0)/l9_4.x;
float l9_9=1.0-l9_8;
float l9_10=((sliceSizeBottom*l9_5)*2.0)/l9_4.y;
float l9_11=((sliceSizeTop*l9_5)*2.0)/l9_4.y;
float l9_12=1.0-l9_11;
float l9_13=1.0-sliceSizeRight;
float l9_14=1.0-sliceSizeTop;
float l9_15;
if (l9_0.x<l9_7)
{
l9_15=(l9_0.x*sliceSizeLeft)/l9_7;
}
else
{
l9_15=(l9_0.x<l9_9) ? (sliceSizeLeft+(((l9_0.x-l9_7)*(l9_13-sliceSizeLeft))/(l9_9-l9_7))) : (l9_13+(((l9_0.x-l9_9)*sliceSizeRight)/l9_8));
}
float l9_16;
if (l9_0.y<l9_10)
{
l9_16=(l9_0.y*sliceSizeBottom)/l9_10;
}
else
{
l9_16=(l9_0.y<l9_12) ? (sliceSizeBottom+(((l9_0.y-l9_10)*(l9_14-sliceSizeBottom))/(l9_12-l9_10))) : (l9_14+(((l9_0.y-l9_12)*sliceSizeTop)/l9_11));
}
...
#endif
Value1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_18,l9_17,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex)*shapeColor;
Result=Value1;
}
else
{
vec2 l9_19=Globals.Surface_UVCoord0;
vec2 l9_20=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_21=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.0005)>0.0;
bool l9_22;
if (l9_21)
{
l9_22=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.0005)<0.0;
}
else
{
l9_22=l9_21;
...
if (!l9_22)
{
l9_23=l9_20*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y*10.0);
}
else
{
l9_23=l9_20;
}
float l9_24=min(min(borderScale,l9_23.x*0.5),l9_23.y*0.5);
float l9_25=(baseTexSize.x/baseTexSize.y)*l9_24;
float l9_26=((sliceSizeLeft*l9_25)*2.0)/l9_23.x;
float l9_27=((sliceSizeRight*l9_25)*2.0)/l9_23.x;
float l9_28=1.0-l9_27;
float l9_29=((sliceSizeBottom*l9_24)*2.0)/l9_23.y;
float l9_30=((sliceSizeTop*l9_24)*2.0)/l9_23.y;
float l9_31=1.0-l9_30;
float l9_32=1.0-sliceSizeRight;
float l9_33=1.0-sliceSizeTop;
float l9_34;
if (l9_19.x<l9_26)
{
l9_34=(l9_19.x*sliceSizeLeft)/l9_26;
}
else
{
l9_34=(l9_19.x<l9_28) ? (sliceSizeLeft+(((l9_19.x-l9_26)*(l9_32-sliceSizeLeft))/(l9_28-l9_26))) : (l9_32+(((l9_19.x-l9_28)*sliceSizeRight)/l9_27));
}
float l9_35;
if (l9_19.y<l9_29)
{
l9_35=(l9_19.y*sliceSizeBottom)/l9_29;
}
else
{
l9_35=(l9_19.y<l9_31) ? (sliceSizeBottom+(((l9_19.y-l9_29)*(l9_33-sliceSizeBottom))/(l9_31-l9_29))) : (l9_33+(((l9_19.y-l9_31)*sliceSizeTop)/l9_30));
}
...
#endif
vec4 l9_38=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_37,l9_36,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex)*shapeColor;
vec4 l9_39=vec4(0.0);
l9_39.x=l9_38.x;
vec4 l9_40=l9_39;
l9_40.y=l9_38.y;
...
void Node19_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
...
l9_6.z=0.968;
vec4 l9_7=l9_6;
l9_7.w=sc_SampleTextureBiasOrLevel(active_txtDims.xy,active_txtLayout,l9_3,((l9_2-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_active_txt)!=0),active_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_active_txt,SC_SOFTWARE_WRAP_MODE_V_active_txt),(int(SC_USE_UV_MIN_MAX_active_txt)!=0),active_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_active_txt)!=0),active_txtBorderColor,0.0,active_txt).w;
Value1=l9_7;
Result=Value1;
}
else
{
vec2 l9_8=Globals.Surface_UVCoord0;
int l9_9;
#if (active_txtHasSwappedViews)
{
...
l9_12.z=0.871;
vec4 l9_13=l9_12;
l9_13.w=sc_SampleTextureBiasOrLevel(active_txtDims.xy,active_txtLayout,l9_9,((l9_8-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_active_txt)!=0),active_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_active_txt,SC_SOFTWARE_WRAP_MODE_V_active_txt),(int(SC_USE_UV_MIN_MAX_active_txt)!=0),active_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_active_txt)!=0),active_txtBorderColor,0.0,active_txt).w;
Default=l9_13;
Result=Default;
}
}
...
vec4 param_3;
Node19_If_else(0.0,vec4(0.0),vec4(0.0),param_3,l9_3);
