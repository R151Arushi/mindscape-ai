...
if (Switch==0.0)
{
float l9_0=length((Globals.Surface_UVCoord0-vec2(0.5))*vec2(edited_scale));
...
if (Switch==1.0)
{
float l9_6=length((Globals.Surface_UVCoord0-vec2(0.5))*vec2(hover_scale));
...
if (Switch==2.0)
{
float l9_12=length((Globals.Surface_UVCoord0-vec2(0.5))*vec2(selected_scale));
...
{
float l9_18=length((Globals.Surface_UVCoord0-vec2(0.5))*vec2(default_scale));
...
{
if (l9_3.w<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_4=ngsPixelShader(l9_3);
vec4 l9_5=max(l9_4,vec4(0.0));
sc_writeFragData0(l9_5);
vec4 l9_6=clamp(l9_5,vec4(0.0),vec4(1.0));
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_7=varViewSpaceDepth;
}
#else
{
l9_7=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_8=clamp(l9_7*0.001,0.0,1.0);
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_9=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_10;
#if (sc_SkinBonesCount>0)
{
l9_10=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_9.x)>l9_10)
{
discard;
}
