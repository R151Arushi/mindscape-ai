...
//texture texture2D intensityTexture 2:0:2:11
//texture texture2D sc_OITAlpha0 2:1:2:12
//texture texture2D sc_OITAlpha1 2:2:2:12
//texture texture2D sc_OITDepthHigh0 2:3:2:12
//texture texture2D sc_OITDepthHigh1 2:4:2:12
//texture texture2D sc_OITDepthLow0 2:5:2:12
//texture texture2D sc_OITDepthLow1 2:6:2:12
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:7:2:12
//texture texture2D sc_OITFrontDepthTexture 2:8:2:12
//SG_REFLECTION_END
...
float l9_0=floor(float(xRightPin));
float l9_1;
if (l9_0==0.0)
{
l9_1=0.0;
...
if (l9_0==1.0)
{
l9_2=clamp((strokeThickness*0.065)+(-0.5),-0.5,-0.435);
}
else
{
l9_2=0.0;
...
float l9_3=floor(float(xLeftPin));
bool l9_4=l9_3==0.0;
float l9_5;
if (l9_4)
{
...
if (l9_3==1.0)
{
l9_6=clamp((strokeThickness*0.065)+(-0.5),-0.5,-0.435);
}
else
{
l9_6=0.0;
...
float l9_7=l9_5-l9_1;
float l9_8=(shapeWidthX*l9_7)+l9_1;
float l9_9;
if (l9_5>l9_1)
{
l9_9=clamp(l9_8,l9_1,l9_5);
}
else
{
l9_9=clamp(l9_8,l9_5,l9_1);
}
float l9_10;
if (l9_4)
{
...
if (l9_3==1.0)
{
l9_13=clamp(strokeThickness*(-0.065),-0.065,0.0);
}
else
{
l9_13=0.0;
...
float l9_14=(1.0-l9_11)+l9_12;
float l9_15=l9_9+l9_14;
...
if (l9_16==1.0)
{
l9_18=clamp((strokeThickness*0.065)+(-0.5),-0.5,-0.435);
}
else
{
l9_18=0.0;
...
if (l9_19==1.0)
{
l9_22=clamp((strokeThickness*0.065)+(-0.5),-0.5,-0.435);
}
else
{
l9_22=0.0;
...
float l9_24=(shapeHeightY*l9_23)+l9_17;
float l9_25;
if (l9_21>l9_17)
{
...
if (l9_19==1.0)
{
l9_29=clamp(strokeThickness*(-0.065),-0.065,0.0);
}
else
{
l9_29=0.0;
...
l9_30.x=l9_15;
vec2 l9_31=l9_30;
l9_31.y=l9_25+(l9_27+l9_28);
vec2 l9_32=(varPackedTex.xy+l9_31)-vec2(0.5);
float l9_33=radians(shapeRotation);
float l9_34=sin(l9_33);
float l9_35=cos(l9_33);
float l9_36=strokeThickness*0.133333;
float l9_37=1.0-l9_36;
float l9_38=shapeWidthX*l9_37;
bool l9_39=l9_37>0.0;
float l9_40;
if (l9_39)
{
l9_40=clamp(l9_38,0.0,l9_37);
}
else
{
l9_40=clamp(l9_38,l9_37,0.0);
}
float l9_41=shapeHeightY*l9_37;
float l9_42;
if (l9_39)
{
l9_42=clamp(l9_41,0.0,l9_37);
}
else
{
l9_42=clamp(l9_41,l9_37,0.0);
}
vec2 l9_43=vec2(0.0);
l9_43.x=l9_40;
vec2 l9_44=l9_43;
l9_44.y=l9_42;
float l9_45=min(abs(shapeRoundness),l9_40);
float l9_46=min(l9_45,l9_42);
float l9_47=max(l9_46,0.001);
float l9_48=l9_38+l9_36;
bool l9_49=1.0>l9_36;
float l9_50;
if (l9_49)
{
l9_50=clamp(l9_48,l9_36,1.0);
}
else
{
l9_50=clamp(l9_48,1.0,l9_36);
}
float l9_51=l9_41+l9_36;
float l9_52;
if (l9_49)
{
l9_52=clamp(l9_51,l9_36,1.0);
}
else
{
l9_52=clamp(l9_51,1.0,l9_36);
}
vec2 l9_53=vec2(0.0);
l9_53.x=l9_50;
vec2 l9_54=l9_53;
l9_54.y=l9_52;
float l9_55=strokeThickness*clamp((shapeRoundness-0.001)*17.7778,0.0,0.16);
float l9_56=(shapeRoundness*(1.0-l9_55))+l9_55;
float l9_57;
if (1.0>l9_55)
{
l9_57=clamp(l9_56,l9_55,1.0);
}
else
{
l9_57=clamp(l9_56,1.0,l9_55);
}
float l9_58=abs(l9_57);
float l9_59=min(l9_58,l9_50);
float l9_60=min(l9_59,l9_52);
float l9_61=max(l9_60,0.001);
vec4 l9_62=vec4(0.5,0.5,0.5,0.0);
l9_62.w=0.0;
vec2 l9_63=abs(((vec2(dot(vec2(l9_35,l9_34),l9_32),dot(vec2(-l9_34,l9_35),l9_32))+vec2(0.5))*vec2(2.0))+vec2(-1.0));
float l9_64=1.0-(length(max((l9_63-l9_44)+vec2(l9_47),vec2(0.0)))/l9_47);
float l9_65=fwidth(l9_64);
float l9_66=clamp((l9_64/l9_65)+0.001,0.001,1.001);
float l9_67=1.0-(length(max((l9_63-l9_54)+vec2(l9_61),vec2(0.0)))/l9_61);
float l9_68=fwidth(l9_67);
float l9_69=(clamp(((1.001-l9_66)*(clamp((l9_67/l9_68)+0.001,0.001,1.001)-0.001))+0.001,0.001,1.001)-0.001)*strokeAlpha;
float l9_70=(l9_66-0.001)*shapeAlpha;
vec4 l9_71;
if (float(Active)!=0.0)
{
l9_71=strokeColorActive;
}
else
{
l9_71=strokeColorInactive;
}
vec4 l9_72=mix(mix(l9_62,vec4(shapeColor.xyz,1.0),vec4(clamp(((l9_69+l9_70)-max(l9_69,l9_70))+l9_70,0.0,1.0))),l9_71,vec4(l9_69));
float l9_73=l9_72.w;
...
{
if (l9_73<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_74=ngsPixelShader(l9_72);
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_77=varViewSpaceDepth;
}
#else
{
l9_77=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_78=clamp(l9_77*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_78),min(1.0,l9_78+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
oitDepthGather(l9_76);
}
#else
{
#if (sc_OITCompositingPass)
{
oitCompositing(l9_76);
}
#else
{
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_79=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_80;
#if (sc_SkinBonesCount>0)
{
l9_80=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_79.x)>l9_80)
{
discard;
}
