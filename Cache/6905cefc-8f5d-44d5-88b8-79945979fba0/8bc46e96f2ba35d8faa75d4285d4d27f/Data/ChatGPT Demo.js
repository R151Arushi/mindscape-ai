...
function onUpdate() {
    ...
    print(script.camArm.worldSpaceToScreenSpace(script.armLeft.getTransform().getWorldPosition()).distance(script.camPlane.worldSpaceToScreenSpace(script.boxHandle.getTransform().getWorldPosition())));
