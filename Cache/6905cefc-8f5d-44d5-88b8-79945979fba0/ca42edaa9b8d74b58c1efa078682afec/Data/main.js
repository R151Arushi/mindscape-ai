...
var rotationToApply1 = quat.angleAxis(12, axis1);
var rotationToApply2 = quat.angleAxis(-33, axis2);
...
script.magicBox.getTransform().setWorldRotation(rotationToApply1);
script.magicBox.getTransform().setWorldRotation(rotationToApply2);




        // script.magicBox.getTransform().setWorldRotation(quat.lookAt(script.camPlane.getTransform().getWorldPosition(), new vec3(0,-1,0)));
