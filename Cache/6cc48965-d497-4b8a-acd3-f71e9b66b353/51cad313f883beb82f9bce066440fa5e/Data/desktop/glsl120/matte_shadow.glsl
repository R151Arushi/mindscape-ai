...
{
if (Port_Value2_N001<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
{
l9_26=(1.0-dot(l9_20.xyz,vec3(0.33333)))*Port_Value2_N001;
}
#else
{
float l9_27;
...
{
l9_31=dot(l9_20.xyz,vec3(0.33333))*Port_Value2_N001;
}
#else
{
float l9_32;
...
{
l9_51=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_51=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_55=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_55),min(1.0,l9_55+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_59.x=l9_58;
vec4 l9_61=l9_59;
l9_61.y=packValue(l9_57);
vec4 l9_63=l9_61;
l9_63.z=packValue(l9_57);
vec4 l9_65=l9_63;
l9_65.w=packValue(l9_57);
vec4 l9_67=vec4(0.0);
l9_67.x=packValue(l9_57);
vec4 l9_69=l9_67;
l9_69.y=packValue(l9_57);
vec4 l9_71=l9_69;
l9_71.z=packValue(l9_57);
vec4 l9_72=l9_71;
l9_72.w=packValue(l9_57);
int l9_73=int(l9_54.w*255.0);
float l9_74=packValue(l9_73);
vec4 l9_75=vec4(0.0);
l9_75.x=l9_74;
vec4 l9_77=l9_75;
l9_77.y=packValue(l9_73);
vec4 l9_79=l9_77;
l9_79.z=packValue(l9_73);
vec4 l9_80=l9_79;
l9_80.w=packValue(l9_73);
sc_writeFragData0(l9_72);
sc_writeFragData1(l9_65);
sc_writeFragData2(l9_80);
...
#if (sc_OITCompositingPass)
{
vec2 l9_81=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_92==0)
{
l9_95=texture2D(sc_OITAlpha0,l9_81);
l9_94=texture2D(sc_OITDepthLow0,l9_81);
l9_93=texture2D(sc_OITDepthHigh0,l9_81);
}
else
{
l9_95=l9_88;
...
if (l9_92==1)
{
l9_91=texture2D(sc_OITAlpha1,l9_81);
l9_90=texture2D(sc_OITDepthLow1,l9_81);
l9_89=texture2D(sc_OITDepthHigh1,l9_81);
}
else
{
l9_91=l9_95;
...
{
int l9_96[8]=l9_82;
unpackValues(l9_89.w,l9_92,l9_96);
unpackValues(l9_89.z,l9_92,l9_96);
unpackValues(l9_89.y,l9_92,l9_96);
unpackValues(l9_89.x,l9_92,l9_96);
unpackValues(l9_90.w,l9_92,l9_96);
unpackValues(l9_90.z,l9_92,l9_96);
unpackValues(l9_90.y,l9_92,l9_96);
unpackValues(l9_90.x,l9_92,l9_96);
int l9_105[8]=l9_83;
unpackValues(l9_91.w,l9_92,l9_105);
unpackValues(l9_91.z,l9_92,l9_105);
unpackValues(l9_91.y,l9_92,l9_105);
unpackValues(l9_91.x,l9_92,l9_105);
}
l9_88=l9_91;
l9_87=l9_90;
l9_86=l9_89;
...
vec4 l9_110=texture2D(sc_OITFilteredDepthBoundsTexture,l9_81);
...
if (l9_120)
{
vec3 l9_121=l9_114.xyz*(1.0-(float(l9_83[l9_116])*0.00392157));
