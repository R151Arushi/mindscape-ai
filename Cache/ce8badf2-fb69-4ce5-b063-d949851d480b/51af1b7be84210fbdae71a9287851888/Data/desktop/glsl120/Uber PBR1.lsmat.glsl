...
#endif
l9_47=N7_vec3srgbToLinear(l9_49)*ssPow(l9_55,rimExponent);
}
#else
{
l9_47=vec3(0.0);
...
#endif
vec3 l9_56=ssPow((l9_31+l9_32)+l9_47,vec3(0.454545));
...
{
vec3 l9_63=mix(vec3(0.04),l9_16.xyz*l9_60,vec3(l9_60));
...
{
if (l9_66<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
vec3 l9_78=mix(vec3(0.04),l9_73*l9_69,l9_77);
...
#endif
l9_134=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_135,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_136;
...
#else
{
l9_136=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_133,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_134=l9_136;
}
...
l9_139=(((((((sc_Sh[8]*0.429043)*((l9_141*l9_141)-(l9_142*l9_142)))+((sc_Sh[6]*0.743125)*(l9_143*l9_143)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_141*l9_142))+(sc_Sh[7]*(l9_141*l9_143)))+(sc_Sh[5]*(l9_142*l9_143)))*0.858086))+((((sc_Sh[3]*l9_141)+(sc_Sh[1]*l9_142))+(sc_Sh[2]*l9_143))*1.02333))*sc_ShIntensity;
}
#else
{
l9_139=vec3(0.0);
...
float l9_163=0.36*l9_157;
float l9_164=0.694444*l9_162;
...
l9_155=l9_154+((((sc_LightEstimationData.sg[l9_156].color/vec3(sc_LightEstimationData.sg[l9_156].sharpness))*6.28319)*((l9_161*l9_166)+(((l9_158-l9_159)*l9_160)-l9_159)))*vec3(0.31831));
l9_154=l9_155;
l9_156++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_168=clamp(pow(l9_70,0.666667),0.0,1.0)*5.0;
...
#endif
l9_167=(((l9_170.xyz*(1.0/l9_170.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_80,abs(dot(l9_74,l9_6)));
}
#else
{
l9_167=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_174=clamp(l9_70*l9_70,0.01,1.0);
vec3 l9_175;
...
float l9_180=(2.0/l9_177)/(4.0*max(l9_179,0.0001));
...
l9_175+=((((((((vec3(0.31831/l9_177)*exp((l9_181-l9_180)-sc_LightEstimationData.sg[l9_176].sharpness))*sc_LightEstimationData.sg[l9_176].color)*6.28319)*(1.0-exp((-2.0)*l9_181)))/vec3(l9_181))*((1.0/(l9_182+sqrt(l9_177+((l9_184*l9_182)*l9_182))))*(1.0/(l9_183+sqrt(l9_177+((l9_184*l9_183)*l9_183))))))*(l9_78+((vec3(1.0)-l9_78)*pow(1.0-clamp(dot(l9_178,normalize(l9_178+l9_6)),0.0,1.0),5.0))))*l9_182);
l9_176++;
continue;
}
else
...
{
vec4 l9_201=l9_199;
l9_201.x=l9_198+((l9_76.x*l9_72.x)*1e-05);
l9_200=l9_201;
}
#else
{
...
{
vec3 l9_203=linearToneMapping(l9_200.xyz);
l9_202=vec4(l9_203.x,l9_203.y,l9_203.z,l9_200.w);
}
#else
{
l9_202=l9_200;
...
#endif
vec3 l9_204=vec3(linearToSrgb(l9_202.x),linearToSrgb(l9_202.y),linearToSrgb(l9_202.z));
l9_68=vec4(l9_204.x,l9_204.y,l9_204.z,l9_202.w);
}
#else
{
...
#endif
vec4 l9_205=max(l9_68,vec4(0.0));
vec4 l9_206;
#if (sc_ProjectiveShadowsCaster)
{
float l9_207;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_208=clamp(l9_205.w*2.0,0.0,1.0);
}
#else
{
float l9_209;
...
{
l9_209=clamp(dot(l9_205.xyz,vec3(l9_205.w)),0.0,1.0);
}
#else
{
float l9_210;
...
#if (sc_BlendMode_Multiply)
{
l9_211=(1.0-dot(l9_205.xyz,vec3(0.33333)))*l9_205.w;
}
#else
{
float l9_212;
...
{
l9_212=(1.0-clamp(dot(l9_205.xyz,vec3(1.0)),0.0,1.0))*l9_205.w;
}
#else
{
float l9_213;
#if (sc_BlendMode_ColoredGlass)
{
l9_213=clamp(dot(l9_205.xyz,vec3(1.0)),0.0,1.0)*l9_205.w;
}
#else
{
float l9_214;
#if (sc_BlendMode_Add)
{
l9_214=clamp(dot(l9_205.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_215;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_215=clamp(dot(l9_205.xyz,vec3(1.0)),0.0,1.0)*l9_205.w;
}
#else
{
float l9_216;
...
{
l9_216=dot(l9_205.xyz,vec3(0.33333))*l9_205.w;
}
#else
{
float l9_217;
#if (sc_BlendMode_Min)
{
l9_217=1.0-clamp(dot(l9_205.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_218;
#if (sc_BlendMode_Max)
{
l9_218=clamp(dot(l9_205.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_218=1.0;
...
#endif
l9_206=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_205.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_207);
}
#else
{
vec4 l9_219;
...
vec3 l9_222=mix(l9_221,definedBlend(l9_221,l9_205.xyz).xyz,vec3(l9_205.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_225=l9_205.w;
l9_224=vec4(mix(vec3(1.0),l9_205.xyz,vec3(l9_225)),l9_225);
}
#else
{
vec4 l9_226;
...
#endif
l9_226=vec4(l9_205.xyz*l9_228,l9_228);
}
#else
{
l9_226=l9_205;
...
{
l9_231=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_231=vec4(0.0);
...
vec4 l9_233=max(l9_232,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_235=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_235),min(1.0,l9_235+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_236=sc_ScreenCoordsGlobalToView(l9_5);
...
vec4 l9_239=vec4(0.0);
l9_239.x=l9_238;
vec4 l9_241=l9_239;
l9_241.y=packValue(l9_237);
vec4 l9_243=l9_241;
l9_243.z=packValue(l9_237);
vec4 l9_245=l9_243;
l9_245.w=packValue(l9_237);
vec4 l9_247=vec4(0.0);
l9_247.x=packValue(l9_237);
vec4 l9_249=l9_247;
l9_249.y=packValue(l9_237);
vec4 l9_251=l9_249;
l9_251.z=packValue(l9_237);
vec4 l9_252=l9_251;
l9_252.w=packValue(l9_237);
int l9_253=int(l9_234.w*255.0);
float l9_254=packValue(l9_253);
vec4 l9_255=vec4(0.0);
l9_255.x=l9_254;
vec4 l9_257=l9_255;
l9_257.y=packValue(l9_253);
vec4 l9_259=l9_257;
l9_259.z=packValue(l9_253);
vec4 l9_260=l9_259;
l9_260.w=packValue(l9_253);
sc_writeFragData0(l9_252);
sc_writeFragData1(l9_245);
sc_writeFragData2(l9_260);
...
#if (sc_OITCompositingPass)
{
vec2 l9_261=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_272==0)
{
l9_275=texture2D(sc_OITAlpha0,l9_261);
l9_274=texture2D(sc_OITDepthLow0,l9_261);
l9_273=texture2D(sc_OITDepthHigh0,l9_261);
}
else
{
l9_275=l9_268;
...
if (l9_272==1)
{
l9_271=texture2D(sc_OITAlpha1,l9_261);
l9_270=texture2D(sc_OITDepthLow1,l9_261);
l9_269=texture2D(sc_OITDepthHigh1,l9_261);
}
else
{
l9_271=l9_275;
...
{
int l9_276[8]=l9_262;
unpackValues(l9_269.w,l9_272,l9_276);
unpackValues(l9_269.z,l9_272,l9_276);
unpackValues(l9_269.y,l9_272,l9_276);
unpackValues(l9_269.x,l9_272,l9_276);
unpackValues(l9_270.w,l9_272,l9_276);
unpackValues(l9_270.z,l9_272,l9_276);
unpackValues(l9_270.y,l9_272,l9_276);
unpackValues(l9_270.x,l9_272,l9_276);
int l9_285[8]=l9_263;
unpackValues(l9_271.w,l9_272,l9_285);
unpackValues(l9_271.z,l9_272,l9_285);
unpackValues(l9_271.y,l9_272,l9_285);
unpackValues(l9_271.x,l9_272,l9_285);
}
l9_268=l9_271;
l9_267=l9_270;
l9_266=l9_269;
...
vec4 l9_290=texture2D(sc_OITFilteredDepthBoundsTexture,l9_261);
...
if (l9_300)
{
vec3 l9_301=l9_294.xyz*(1.0-(float(l9_263[l9_296])*0.00392157));
