...
//sampler sampler backgroundSmpSC 2:16
...
//texture texture2D background 2:0:2:16
...
#if (faceted)
{
vec3 l9_4=cross(vec3(dFdx(varPos.x),dFdx(varPos.y),dFdx(varPos.z)),vec3(dFdy(varPos.x),dFdy(varPos.y),dFdy(varPos.z)));
...
vec2 l9_8=l9_1+(vec2(refract(l9_5,l9_3*l9_7,Port_Input0_N005/Tweak_N8).xy)*vec2(intensity));
float l9_9=dot(l9_2,l9_3);
float l9_10=1.0-clamp(l9_9,0.0,1.0);
vec2 l9_11=vec2((chromaticAberration*l9_10)*Port_Input2_N012);
vec3 l9_12=vec3(0.0);
l9_12.x=sc_SampleTextureBiasOrLevel(backgroundDims.xy,backgroundLayout,backgroundGetStereoViewIndex(),l9_8+l9_11,(int(SC_USE_UV_TRANSFORM_background)!=0),backgroundTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_background,SC_SOFTWARE_WRAP_MODE_V_background),(int(SC_USE_UV_MIN_MAX_background)!=0),backgroundUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_background)!=0),backgroundBorderColor,thickness,background).x;
vec3 l9_13=l9_12;
l9_13.y=sc_SampleTextureBiasOrLevel(backgroundDims.xy,backgroundLayout,backgroundGetStereoViewIndex(),l9_8,(int(SC_USE_UV_TRANSFORM_background)!=0),backgroundTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_background,SC_SOFTWARE_WRAP_MODE_V_background),(int(SC_USE_UV_MIN_MAX_background)!=0),backgroundUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_background)!=0),backgroundBorderColor,thickness,background).y;
vec3 l9_14=l9_13;
l9_14.z=sc_SampleTextureBiasOrLevel(backgroundDims.xy,backgroundLayout,backgroundGetStereoViewIndex(),l9_8-l9_11,(int(SC_USE_UV_TRANSFORM_background)!=0),backgroundTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_background,SC_SOFTWARE_WRAP_MODE_V_background),(int(SC_USE_UV_MIN_MAX_background)!=0),backgroundUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_background)!=0),backgroundBorderColor,thickness,background).z;
float l9_15=abs(l9_10);
float l9_16;
if (l9_15<=0.0)
{
l9_16=0.0;
...
{
l9_16=pow(l9_15,exponent);
}
float l9_17=1.0-l9_16;
float l9_18=mix(Port_Input0_N025,l9_17,darken);
vec3 l9_19;
...
{
if (Port_Opacity_N006<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec3 l9_20=max((colorTint.xyz*l9_14)*vec3(l9_18*l9_18),vec3(0.0));
vec4 l9_21;
#if (!sc_ProjectiveShadowsCaster)
{
vec3 l9_22=ssSRGB_to_Linear(l9_20);
vec3 l9_23=normalize(l9_19);
vec3 l9_24=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_25;
#if (sc_SSAOEnabled)
{
l9_25=evaluateSSAO(varPos);
}
#else
{
l9_25=Port_AO_N006;
...
#endif
vec3 l9_26=vec3(Port_Metallic_N006);
vec3 l9_27=mix(vec3(0.04),l9_22*Port_Metallic_N006,l9_26);
vec3 l9_28=mix(l9_22*(1.0-Port_Metallic_N006),vec3(0.0),l9_26);
SurfaceProperties l9_29=SurfaceProperties(l9_28,Port_Opacity_N006,l9_23,varPos,l9_2,Port_Metallic_N006,Port_Roughness_N006,l9_24,l9_25,Port_SpecularAO_N006,vec3(1.0),l9_27);
vec4 l9_30=vec4(1.0);
vec3 l9_31;
vec3 l9_32;
vec3 l9_33;
...
l9_39=vec3(0.0);
l9_38=vec3(0.0);
LightingComponents l9_45;
LightProperties l9_46;
SurfaceProperties l9_47;
vec3 l9_48;
int l9_49=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_49<sc_DirectionalLightsCount)
{
LightingComponents l9_50=accumulateLight(LightingComponents(l9_38,l9_39,l9_44,l9_43,l9_41,l9_40),LightProperties(sc_DirectionalLights[l9_49].direction,sc_DirectionalLights[l9_49].color.xyz,sc_DirectionalLights[l9_49].color.w*l9_30[(l9_42<3) ? l9_42 : 3]),l9_29,l9_2);
l9_44=l9_50.indirectDiffuse;
l9_43=l9_50.indirectSpecular;
l9_42++;
l9_41=l9_50.emitted;
l9_40=l9_50.transmitted;
l9_39=l9_50.directSpecular;
l9_38=l9_50.directDiffuse;
l9_49++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_67<sc_PointLightsCount)
{
vec3 l9_69=sc_PointLights[l9_67].position-varPos;
vec3 l9_70=normalize(l9_69);
float l9_71=l9_30[(l9_68<3) ? l9_68 : 3];
float l9_72=clamp((dot(l9_70,sc_PointLights[l9_67].direction)*sc_PointLights[l9_67].angleScale)+sc_PointLights[l9_67].angleOffset,0.0,1.0);
float l9_73=(sc_PointLights[l9_67].color.w*l9_71)*(l9_72*l9_72);
float l9_74;
if (sc_PointLights[l9_67].falloffEnabled)
{
l9_74=l9_73*computeDistanceAttenuation(length(l9_69),sc_PointLights[l9_67].falloffEndDistance);
}
else
{
l9_74=l9_73;
...
l9_60=l9_68+1;
LightingComponents l9_75=accumulateLight(LightingComponents(l9_54,l9_55,l9_59,l9_58,l9_57,l9_56),LightProperties(l9_70,sc_PointLights[l9_67].color.xyz,l9_74),l9_29,l9_2);
l9_61=l9_75.directDiffuse;
l9_62=l9_75.directSpecular;
l9_63=l9_75.indirectDiffuse;
l9_64=l9_75.indirectSpecular;
l9_65=l9_75.emitted;
l9_66=l9_75.transmitted;
l9_59=l9_63;
l9_58=l9_64;
l9_68=l9_60;
l9_57=l9_65;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_79=abs(varShadowTex-vec2(0.5));
vec4 l9_80=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_79.x,l9_79.y),0.5);
l9_78=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_80.xyz,vec3(sc_ShadowColor.w)),vec3(l9_80.w*sc_ShadowDensity));
}
#else
{
l9_78=vec3(1.0);
...
{
vec2 l9_82=calcPanoramicTexCoordsFromDir(l9_23,sc_EnvmapRotation.y);
vec4 l9_83;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_84=calcSeamlessPanoramicUvsForSampling(l9_82,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_84=l9_82;
...
#endif
l9_83=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_84,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_85;
...
{
vec2 l9_86=calcSeamlessPanoramicUvsForSampling(l9_82,sc_EnvmapDiffuseSize.xy,0.0);
int l9_87;
...
#endif
l9_85=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_86,sc_EnvmapDiffuseLayout,l9_87,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_85=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_82,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_83=l9_85;
}
#endif
l9_81=(l9_83.xyz*(1.0/l9_83.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_88;
...
float l9_91=l9_89.y;
float l9_92=l9_89.z;
l9_88=(((((((sc_Sh[8]*0.429043)*((l9_90*l9_90)-(l9_91*l9_91)))+((sc_Sh[6]*0.743125)*(l9_92*l9_92)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_90*l9_91))+(sc_Sh[7]*(l9_90*l9_92)))+(sc_Sh[5]*(l9_91*l9_92)))*0.858086))+((((sc_Sh[3]*l9_90)+(sc_Sh[1]*l9_91))+(sc_Sh[2]*l9_92))*1.02333))*sc_ShIntensity;
}
#else
{
l9_88=vec3(0.0);
...
{
l9_94=l9_81+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_95=l9_81;
l9_95.x=l9_81.x+(1e-06*sc_AmbientLights[0].color.x);
l9_94=l9_95;
}
#endif
l9_93=l9_94;
...
{
l9_97=l9_93+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_98=l9_93;
l9_98.x=l9_93.x+(1e-06*sc_AmbientLights[1].color.x);
l9_97=l9_98;
}
#endif
l9_96=l9_97;
...
{
l9_100=l9_96+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_101=l9_96;
l9_101.x=l9_96.x+(1e-06*sc_AmbientLights[2].color.x);
l9_100=l9_101;
}
#endif
l9_99=l9_100;
...
{
vec3 l9_103;
l9_103=sc_LightEstimationData.ambientLight;
vec3 l9_104;
int l9_105=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_105<sc_LightEstimationSGCount)
{
float l9_106=dot(sc_LightEstimationData.sg[l9_105].axis,l9_23);
float l9_107=exp(-sc_LightEstimationData.sg[l9_105].sharpness);
float l9_108=l9_107*l9_107;
float l9_109=1.0/sc_LightEstimationData.sg[l9_105].sharpness;
float l9_110=(1.0+(2.0*l9_108))-l9_109;
float l9_111=sqrt(1.0-l9_110);
float l9_112=0.36*l9_106;
float l9_113=0.694444*l9_111;
float l9_114=l9_112+l9_113;
float l9_115;
if (step(abs(l9_112),l9_113)>0.5)
{
l9_115=(l9_114*l9_114)/l9_111;
}
else
{
l9_115=clamp(l9_106,0.0,1.0);
}
l9_104=l9_103+((((sc_LightEstimationData.sg[l9_105].color/vec3(sc_LightEstimationData.sg[l9_105].sharpness))*6.28319)*((l9_110*l9_115)+(((l9_107-l9_108)*l9_109)-l9_108)))*vec3(0.31831));
l9_103=l9_104;
l9_105++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_117=clamp(pow(Port_Roughness_N006,0.666667),0.0,1.0)*5.0;
vec2 l9_118=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_23,reflect(l9_5,l9_23),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_119;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_120=floor(l9_117);
float l9_121=ceil(l9_117);
l9_119=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_118,sc_EnvmapSpecularSize.xy,l9_120),sc_EnvmapSpecularGetStereoViewIndex(),l9_120),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_118,sc_EnvmapSpecularSize.xy,l9_121),sc_EnvmapSpecularGetStereoViewIndex(),l9_121),vec4(l9_117-l9_120));
}
#else
{
l9_119=sc_EnvmapSpecularSampleViewIndexLevel(l9_118,sc_EnvmapSpecularGetStereoViewIndex(),l9_117);
}
#endif
l9_116=(((l9_119.xyz*(1.0/l9_119.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_29,abs(dot(l9_23,l9_2)));
}
#else
{
l9_116=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_123=clamp(Port_Roughness_N006*Port_Roughness_N006,0.01,1.0);
vec3 l9_124;
l9_124=sc_LightEstimationData.ambientLight*l9_27;
int l9_125=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_127=reflect(l9_5,l9_23);
float l9_128=dot(l9_23,l9_2);
float l9_129=(2.0/l9_126)/(4.0*max(l9_128,0.0001));
float l9_130=length((l9_127*l9_129)+(sc_LightEstimationData.sg[l9_125].axis*sc_LightEstimationData.sg[l9_125].sharpness));
float l9_131=clamp(dot(l9_23,l9_127),0.0,1.0);
float l9_132=clamp(l9_128,0.0,1.0);
float l9_133=1.0-l9_126;
l9_124+=((((((((vec3(0.31831/l9_126)*exp((l9_130-l9_129)-sc_LightEstimationData.sg[l9_125].sharpness))*sc_LightEstimationData.sg[l9_125].color)*6.28319)*(1.0-exp((-2.0)*l9_130)))/vec3(l9_130))*((1.0/(l9_131+sqrt(l9_126+((l9_133*l9_131)*l9_131))))*(1.0/(l9_132+sqrt(l9_126+((l9_133*l9_132)*l9_132))))))*(l9_27+((vec3(1.0)-l9_27)*pow(1.0-clamp(dot(l9_127,normalize(l9_127+l9_2)),0.0,1.0),5.0))))*l9_131);
l9_125++;
continue;
}
else
...
l9_137=vec3(0.0);
l9_136=vec3(0.0);
l9_135=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_28,vec3(Port_Opacity_N006));
l9_134=1.0;
}
#else
{
...
#endif
vec3 l9_139=l9_136*l9_25;
vec3 l9_140=l9_137+l9_139;
vec3 l9_141=l9_28*l9_140;
vec3 l9_142=l9_122*Port_SpecularAO_N006;
vec3 l9_143=l9_76+l9_142;
vec3 l9_144;
if (l9_138)
{
...
vec3 l9_146=(l9_145+l9_24)+l9_135;
...
{
vec4 l9_150=l9_148;
l9_150.x=l9_147+((l9_25.x*Port_SpecularAO_N006.x)*1e-05);
l9_149=l9_150;
}
#else
{
...
{
vec3 l9_152=linearToneMapping(l9_149.xyz);
l9_151=vec4(l9_152.x,l9_152.y,l9_152.z,l9_149.w);
}
#else
{
l9_151=l9_149;
...
#endif
vec3 l9_153=vec3(linearToSrgb(l9_151.x),linearToSrgb(l9_151.y),linearToSrgb(l9_151.z));
l9_21=vec4(l9_153.x,l9_153.y,l9_153.z,l9_151.w);
}
#else
{
l9_21=vec4(l9_20,Port_Opacity_N006);
}
#endif
vec4 l9_154=max(l9_21,vec4(0.0));
vec4 l9_155;
#if (sc_ProjectiveShadowsCaster)
{
float l9_156;
...
#if (sc_BlendMode_Multiply)
{
l9_160=(1.0-dot(l9_154.xyz,vec3(0.33333)))*l9_154.w;
}
#else
{
float l9_161;
...
{
l9_165=dot(l9_154.xyz,vec3(0.33333))*l9_154.w;
}
#else
{
float l9_166;
...
{
l9_180=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_180=vec4(0.0);
...
vec4 l9_182=max(l9_181,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_184=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_184),min(1.0,l9_184+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_185=sc_ScreenCoordsGlobalToView(l9_0);
...
l9_188.x=l9_187;
vec4 l9_190=l9_188;
l9_190.y=packValue(l9_186);
vec4 l9_192=l9_190;
l9_192.z=packValue(l9_186);
vec4 l9_194=l9_192;
l9_194.w=packValue(l9_186);
vec4 l9_196=vec4(0.0);
l9_196.x=packValue(l9_186);
vec4 l9_198=l9_196;
l9_198.y=packValue(l9_186);
vec4 l9_200=l9_198;
l9_200.z=packValue(l9_186);
vec4 l9_201=l9_200;
l9_201.w=packValue(l9_186);
int l9_202=int(l9_183.w*255.0);
float l9_203=packValue(l9_202);
vec4 l9_204=vec4(0.0);
l9_204.x=l9_203;
vec4 l9_206=l9_204;
l9_206.y=packValue(l9_202);
vec4 l9_208=l9_206;
l9_208.z=packValue(l9_202);
vec4 l9_209=l9_208;
l9_209.w=packValue(l9_202);
sc_writeFragData0(l9_201);
sc_writeFragData1(l9_194);
sc_writeFragData2(l9_209);
...
#if (sc_OITCompositingPass)
{
vec2 l9_210=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_221==0)
{
l9_224=texture2D(sc_OITAlpha0,l9_210);
l9_223=texture2D(sc_OITDepthLow0,l9_210);
l9_222=texture2D(sc_OITDepthHigh0,l9_210);
}
else
{
l9_224=l9_217;
...
if (l9_221==1)
{
l9_220=texture2D(sc_OITAlpha1,l9_210);
l9_219=texture2D(sc_OITDepthLow1,l9_210);
l9_218=texture2D(sc_OITDepthHigh1,l9_210);
}
else
{
l9_220=l9_224;
...
{
int l9_225[8]=l9_211;
unpackValues(l9_218.w,l9_221,l9_225);
unpackValues(l9_218.z,l9_221,l9_225);
unpackValues(l9_218.y,l9_221,l9_225);
unpackValues(l9_218.x,l9_221,l9_225);
unpackValues(l9_219.w,l9_221,l9_225);
unpackValues(l9_219.z,l9_221,l9_225);
unpackValues(l9_219.y,l9_221,l9_225);
unpackValues(l9_219.x,l9_221,l9_225);
int l9_234[8]=l9_212;
unpackValues(l9_220.w,l9_221,l9_234);
unpackValues(l9_220.z,l9_221,l9_234);
unpackValues(l9_220.y,l9_221,l9_234);
unpackValues(l9_220.x,l9_221,l9_234);
}
l9_217=l9_220;
l9_216=l9_219;
l9_215=l9_218;
...
vec4 l9_239=texture2D(sc_OITFilteredDepthBoundsTexture,l9_210);
...
if (l9_249)
{
vec3 l9_250=l9_243.xyz*(1.0-(float(l9_212[l9_245])*0.00392157));
